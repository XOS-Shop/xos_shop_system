...
////////////////////////////////////////////////////////////////////////////////
  ...
  class mailer extends PHPMailer {
    ...
    {  
      ...
      $this->setLanguage($_SESSION['language'], DIR_FS_SMARTY . 'catalog/languages/' . $_SESSION['language'] . '/');
      ...
      if (EMAIL_USE_HTML == 'true' && $body_html != '') { 
        ...
        if ($embedded_shop_logo != '') {
          $this->addEmbeddedImage(DIR_FS_CATALOG . (is_file(DIR_FS_CATALOG . 'images/email_shop_logo/' . $embedded_shop_logo) ? 'images/email_shop_logo/' : 'images/catalog/templates/' . SELECTED_TPL . '/') . $embedded_shop_logo, 'shop_logo', '', 'base64', 'image/' . substr(strrchr($embedded_shop_logo, '.'), 1));
        } 
