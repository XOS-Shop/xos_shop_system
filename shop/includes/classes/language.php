...
////////////////////////////////////////////////////////////////////////////////
  ...
  class language {
    ...
    function language($lng = '') {
      ...
      $languages_query = xos_db_query("select languages_id, name, code, image, directory from " . TABLE_LANGUAGES . " where use_in_id > '1' and display_in_catalog = '1' order by sort_order");
