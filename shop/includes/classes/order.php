...
////////////////////////////////////////////////////////////////////////////////
  ...
  class order {
    ...
    function cart() {
      ...
      $this->customer = array('c_id' => $customer_address['customers_c_id'],
                              ...
                              'state' => ((xos_not_null($customer_address['entry_state'])) ? $customer_address['entry_state'] : $customer_address['zone_name']),
                              'zone_id' => $customer_address['entry_zone_id'],
                              'country' => array('id' => $customer_address['countries_id'], 'title' => $customer_address['countries_name'], 'iso_code_2' => $customer_address['countries_iso_code_2'], 'iso_code_3' => $customer_address['countries_iso_code_3']),
                              'country_id' => $customer_address['countries_id'],
      ...
      $this->delivery = array('firstname' => $shipping_address['entry_firstname'],
                              ...
                              'state' => ((xos_not_null($shipping_address['entry_state'])) ? $shipping_address['entry_state'] : $shipping_address['zone_name']),
      ...
      $this->billing = array('firstname' => $billing_address['entry_firstname'],
                             ...
                             'state' => ((xos_not_null($billing_address['entry_state'])) ? $billing_address['entry_state'] : $billing_address['zone_name']),
      ...
      for ($i=0, $n=sizeof($products); $i<$n; $i++) {
        $this->products[$index] = array('qty' => $products[$i]['quantity'],
                                        ...
                                        'price_formated' => $currencies->format($products[$i]['price']),
                                        'final_price_formated' => $currencies->format($products[$i]['final_price']),
                                        'total_price_formated' => $currencies->format($products[$i]['quantity'] * $products[$i]['final_price']),
        ...
        if ($products[$i]['attributes']) {
          ...
          while (list($option, $value) = each($products[$i]['attributes'])) {
            ...
            $this->products[$index]['attributes'][$subindex] = array('option' => $attributes['products_options_name'],
                                                                     ...
                                                                     'price_formated' => $currencies->format($attributes_price));
