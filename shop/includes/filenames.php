...
// define the filenames used in the project
  ...
  define('FILENAME_CSS', 'css.php');  
  define('FILENAME_DEFAULT', 'index.php');
  define('FILENAME_DOWNLOAD', 'download.php');
  define('FILENAME_IMAGES_WINDOW', 'images_window.php');
  define('FILENAME_JS', 'js.php');  
  define('FILENAME_LOGIN', 'login.php');
  define('FILENAME_LOGOFF', 'logoff.php');
  define('FILENAME_NEWSLETTER_SUBSCRIBE', 'newsletter_subscribe.php');
  define('FILENAME_NEW_PRODUCTS', 'new_products.php');
  define('FILENAME_OFFLINE', 'offline.php');
  define('FILENAME_OPTIONS_LIST', 'options_list.php');   
  define('FILENAME_OPTIONS_WINDOW', 'options_window.php');    
  ...
  define('FILENAME_QUICK_SEARCH_SUGGEST', 'quick_search_suggest.php');
  ...
  define('FILENAME_UPDATE_OPTIONS', 'update_options.php');  
