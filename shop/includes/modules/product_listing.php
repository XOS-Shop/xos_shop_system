...
// ende alternative Sortierung fuer product_listing_b                                                                                               
  ...
  if ($listing_split->number_of_rows > 0) {      
    ...
    $smarty->assign(array('listing' => true,
                          ...
                          'nav_bar_result' => TEXT_RESULT_PAGE . ' ' . $listing_split->display_links(MAX_DISPLAY_PAGE_LINKS, xos_get_all_get_params(array('page', 'info', 'lnc', 'currency', 'tpl', 'x', 'y'))),
                          'nav_bar_result_in_pull_down_menu' => $listing_split->display_links_in_pull_down_menu(MAX_DISPLAY_PAGE_LINKS, xos_get_all_get_params(array('page', 'info', 'lnc', 'currency', 'tpl', 'x', 'y'))),
