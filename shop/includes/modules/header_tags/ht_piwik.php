  ...
  class ht_piwik {
    ...
    function execute() {
      ...
      if (xos_not_null(MODULE_HEADER_TAGS_PIWIK_ID)) {
        ...
        if ( (MODULE_HEADER_TAGS_PIWIK_EC_TRACKING == 'true') && ($_SERVER['BASENAME_PHP_SELF'] == FILENAME_PRODUCT_INFO) && ($_GET['p'] != '') ) {
        ...
        if ( (MODULE_HEADER_TAGS_PIWIK_EC_TRACKING == 'true') && ($_SERVER['BASENAME_PHP_SELF'] == FILENAME_CHECKOUT_SUCCESS) && isset($_SESSION['customer_id']) ) {
