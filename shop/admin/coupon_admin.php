...
*/                                    
    ...
    $smarty->assign(array('new' => true,                            
                          ...
                          'input_coupon_startdate' => xos_draw_input_field('coupon_startdate', xos_date_format(DATE_FORMAT_SHORT), 'id="coupon_startdate" style="background: #ffffcc;" size ="10" autocomplete="off"'),
                          'input_coupon_finishdate' => xos_draw_input_field('coupon_finishdate', xos_date_format(DATE_FORMAT_SHORT, mktime(0, 0, 0, date("m"), date("d"), date("Y")+1)), 'id="coupon_finishdate" style="background: #ffffcc;" size ="10" autocomplete="off"'),                                                    
                          'link_filename_coupon_admin' => xos_href_link(FILENAME_COUPON_ADMIN),
