        ...
        if ($banner_error == false) { 
          ...
          for ($i=0, $n=sizeof($languages); $i<$n; $i++) {                      
            ...
            $sql_data_array = array('banners_title' => $banners_title[$languages[$i]['id']],
                                    ...
                                    'banners_html_text' => preg_replace_callback(array('#href=\"?(([^\" >]*?)(\.php)([^\" >]*?))#siU','#href=\"?(([^\" >]*?)(\.html/[a-rz])([^\" >]*?))#siU','#href=\"?(([^\" >]*?)(\.[a-rz])([^\" >]*?))#siU'), 'internal_link_replacement', (trim(str_replace('&#160;', '', strip_tags($banners_html_text[$languages[$i]['id']], '<img>'))) != '') ? $banners_html_text[$languages[$i]['id']] : ''),
