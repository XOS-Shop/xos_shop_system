...
// TABLES: products_options, products_options_values, products_options_values_to_products_options
  function xos_js_option_values_list($option_name, $form, $field) {
    $options_query = xos_db_query("select distinct po.products_options_id, po.products_options_name from " . TABLE_PRODUCTS_OPTIONS . " po, " . TABLE_PRODUCTS_OPTIONS_VALUES_TO_PRODUCTS_OPTIONS . " pov2po where po.products_options_id = pov2po.products_options_id and po.language_id = '" . (int)$_SESSION['used_lng_id'] . "' order by po.products_options_name");  
    $num_option_name = 1;
    $output_string = '';
