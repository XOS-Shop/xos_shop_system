...
// class methods
    function format($number, $currency_value = '', $currency_type = DEFAULT_CURRENCY) {
      ($currency_value !== 1 && !empty($currency_type)) ? $currency_value = $this->currencies[$currency_type]['value'] : $currency_value = 1;
