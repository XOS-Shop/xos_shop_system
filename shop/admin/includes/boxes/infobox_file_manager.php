...
//                                                                     
// filename   : infobox_file_manager.php
...
if (!((@include DIR_FS_SMARTY . 'admin/templates/' . ADMIN_TPL . '/php/includes/boxes/infobox_file_manager.php') == 'overwrite_all')) :
    $contents = array();
    switch ($action) {
      case 'delete':
  ...
  $smarty->assign('infobox_file_manager', $output_infobox_file_manager);
endif;
?>
