...
if (!((@include DIR_FS_SMARTY . 'admin/templates/' . ADMIN_TPL . '/php/includes/boxes/menubox_catalog.php') == 'overwrite_all')) :
  $menu_box_contents = array();
    ...
    if (xos_admin_check_files(FILENAME_DELIVERY_TIMES)) $menu_box_contents[] = array('link' => xos_href_link(FILENAME_DELIVERY_TIMES, 'selected_box=catalog'), 'selected' => $_SESSION['selected_box'] == 'catalog' && FILENAME_DELIVERY_TIMES == basename($_SERVER['PHP_SELF']) ? true : false, 'name' => BOX_CATALOG_DELIVERY_TIMES);
