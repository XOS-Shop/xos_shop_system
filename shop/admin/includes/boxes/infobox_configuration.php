  ...
  switch ($action) {
    case 'edit':
      ...
      if ($cInfo->set_function) {     
        ...
        $value_field = '<div class="form-group">' . xos_draw_input_field('configuration_value', $cInfo->configuration_value, 'class="form-control"') . '</div>';
      }
      ...
      $contents[] = array('text' => '<br /><a href="" onclick="configuration.submit(); return false" class="btn btn-default btn-margin-infobox" title=" ' . BUTTON_TITLE_UPDATE . ' ">' . BUTTON_TEXT_UPDATE . '</a><a href="' . xos_href_link(FILENAME_CONFIGURATION, 'gID=' . $_GET['gID'] . '&cID=' . $cInfo->configuration_id) . '" class="btn btn-default btn-margin-infobox" title=" ' . BUTTON_TITLE_CANCEL . ' ">' . BUTTON_TEXT_CANCEL . '</a><br />&nbsp;');
      break;
    default:
      if (isset($cInfo) && is_object($cInfo)) {
        $heading_title = '<b>' . constant($cInfo->lang_key . '_TITLE') . '</b>';

        $contents[] = array('text' => '<a href="' . xos_href_link(FILENAME_CONFIGURATION, 'gID=' . $_GET['gID'] . '&cID=' . $cInfo->configuration_id . '&action=edit') . '" class="btn btn-default btn-margin-infobox" title=" ' . BUTTON_TITLE_EDIT . ' ">' . BUTTON_TEXT_EDIT . '</a>');
