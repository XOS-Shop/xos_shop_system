                      ...
                      /* <![CDATA[ */
                        $(document).ready(function () {
                          $.fancybox({
                            ...
                            'speedOut':600,
                            'padding':3,
                            'onStart':function() { $("#fancybox-content").css({'border-color':'#b2b2b2'}); $("#shopping_cart_box_title").css({'display':'block'}); $("#shopping_cart_box_content").css({'width':'320px', 'float':'left'}); },
