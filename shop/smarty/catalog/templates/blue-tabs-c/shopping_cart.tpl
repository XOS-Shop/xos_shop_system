...
<!-- shopping_cart -->
    ...
    [@{$form_begin}@]
          <table border="0" width="100%" cellspacing="0" cellpadding="2" class="product-listing-cart">
            ...
            <tr class="product-listing-cart-even">
            [@{/if}@]
              <td colspan="8" class="product-listing-cart-data-last" [@{if !$smarty.foreach.outer.last}@]style="border-bottom: 1px dashed #b6b7cb;"[@{/if}@]><img src="[@{$images_path}@]pixel_trans.gif" alt="" width="100%" height="6" /></td>              
            </tr>                                    
            [@{/foreach}@]
          </table>
          <div style="height: 10px; font-size: 0;">&nbsp;</div>
