...
<!-- checkout_payment -->
    [@{$form_begin}@]
      ...
      [@{if $payment_error}@]
          ...
          <div style="height: 10px; font-size: 0;">&nbsp;</div>            
      [@{/if}@]
          <div class="main"><b>[@{#table_heading_billing_address#}@]</b></div>           
          ...
          <div style="height: 10px; font-size: 0;">&nbsp;</div>
      [@{if $payment_modules}@]           
          <div class="main"><b>[@{#table_heading_payment_method#}@]</b></div>          
          <div class="info-box-central-contents">          
            ...
            <div style="width: 95%; padding: 2px 2px 2px 16px;">             
              ...
              [@{/if}@]                   
                <div class="main" style="width: 74%; padding: 2px; float: left;"><b>[@{$payment_module.loaded_modules}@]</b></div>                               
     ...
     [@{if $checkbox_accept_conditions}@]
          ...
          [@{/if}@]
          [@{if $checkbox_accept_conditions}@]   
            <div class="main" style="padding: 1px;">[@{$checkbox_accept_conditions}@]&nbsp;[@{#text_accept_conditions#}@]</div>             
          [@{/if}@]                          
          </div>        
          <div style="height: 10px; font-size: 0;">&nbsp;</div>                  
     [@{/if}@]
