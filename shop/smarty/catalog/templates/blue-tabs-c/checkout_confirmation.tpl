          ...
          <div class="info-box-central-contents"> 
            <div>                           
                <table border="0" cellspacing="0" cellpadding="2">        
                  <tr>
                   [@{if $tax_groups}@]
                    <td width="20%" nowrap="nowrap" class="product-listing-checkout-confirmation-heading" style="border-top-left-radius: 10px;">[@{#table_heading_products_model#}@]</td>
                    ...
                    <td width="1%" nowrap="nowrap" class="product-listing-checkout-confirmation-heading">&nbsp;</td>
                    <td width="2%" nowrap="nowrap" class="product-listing-checkout-confirmation-heading" style="border-top-right-radius: 10px;" align="right">[@{#table_heading_total#}@]</td>
                   [@{else}@] 
                    <td width="20%" nowrap="nowrap" class="product-listing-checkout-confirmation-heading" style="border-top-left-radius: 10px;">[@{#table_heading_products_model#}@]</td>
                    <td width="8%" nowrap="nowrap" class="product-listing-checkout-confirmation-heading" colspan="2">[@{#table_heading_products#}@]</td>
