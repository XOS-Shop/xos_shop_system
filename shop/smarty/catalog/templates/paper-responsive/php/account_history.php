...
// next button
  ...
  if ($orders_total > 0) {
    ...
    $smarty->assign(array('orders' => true,
                          ...
                          'nav_bar_result' => '<nav><ul class="pagination">' . $history_split->display_links(MAX_DISPLAY_PAGE_LINKS, xos_get_all_get_params(array('page', 'info', 'language', 'currency', 'tpl', 'x', 'y'))) . '</ul></nav>'));
  }
