    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="2">
      ...
      <tr>
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td style="font-family: Verdana, Arial, sans-serif; font-size: 14px;">[@{$smarty.const.CONTACT_US_HTML_EMAIL_TEXT_ENQUIRY}@]:<br /><br /></td>
          </tr>        
          <tr>
            <td style="font-family: Verdana, Arial, sans-serif; font-size: 11px;">[@{$enquiry_text|nl2br}@]</td>
          </tr>
        </table></td>
      </tr>
    </table></td>
