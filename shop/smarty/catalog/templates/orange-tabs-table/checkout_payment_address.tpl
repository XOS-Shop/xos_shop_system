    ...
    <td width="100%" valign="top">[@{$form_begin}@]<table border="0" width="100%" cellspacing="0" cellpadding="0">
     ...
     [@{if !$process}@]            
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr>
            <td class="main"><b>[@{#table_heading_payment_address#}@]</b></td>
          </tr>
        </table></td>
      </tr>
      <tr>
          ...
          <tr class="info-box-central-contents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                ...
                <td class="main" width="50%" valign="top">[@{#text_selected_payment_destination#}@]</td>
                <td align="right" width="50%" valign="top"><table border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td class="main" align="center" valign="top"><b>[@{#title_payment_address#}@]</b><br /><img src="[@{$images_path}@]arrow_south_east.gif" alt="" /></td>
                    <td><img src="[@{$images_path}@]pixel_trans.gif" alt="" width="10" height="1" /></td>
        ...
        <td><table border="0" width="100%" cellspacing="1" cellpadding="2" class="info-box-central">
          <tr class="info-box-central-contents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                <td><img src="[@{$images_path}@]pixel_trans.gif" alt="" width="10" height="1" /></td>
                <td class="main" width="50%" valign="top">[@{#text_select_other_payment_destination#}@]</td>
     ...
     [@{if $not_max_address_book_entries}@]      
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr>
            <td class="main"><b>[@{#table_heading_new_payment_address#}@]</b></td>
        ...
        <td><table border="0" width="100%" cellspacing="1" cellpadding="2" class="info-box-central">
          <tr class="info-box-central-contents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                <td><img src="[@{$images_path}@]pixel_trans.gif" alt="" width="10" height="1" /></td>
                <td class="main" width="100%" valign="top">[@{#text_create_new_payment_address#}@]</td>
                <td><img src="[@{$images_path}@]pixel_trans.gif" alt="" width="10" height="1" /></td>
              </tr>
              <tr>
                <td><img src="[@{$images_path}@]pixel_trans.gif" alt="" width="10" height="1" /></td>
     ...
     [@{if $process}@]
      ...
      <tr>
        <td nowrap="nowrap"><a href="[@{$link_filename_checkout_payment_address}@]" class="button-back" style="float: left" title=" [@{#button_title_back#}@] "><span>[@{#button_text_back#}@]</span></a></td>
      </tr>      
     [@{/if}@]
      <tr>      
        <td><img src="[@{$images_path}@]pixel_trans.gif" alt="" width="100%" height="10" /></td>
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td align="center" width="25%" class="checkout-bar-current">[@{#checkout_bar_payment#}@]</td>
