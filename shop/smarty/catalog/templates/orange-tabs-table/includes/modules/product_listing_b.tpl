            ...
            <div id="sort" class="small-text">
              ...
              <div style="padding: 4px 20px 0 0"> 
                <div id="sort_box">
                  ...
                  [@{else}@]
                  [@{foreach item=heading_top from=$table_heading}@]
...
<table border="0" width="100%" cellspacing="0" cellpadding="2" class="product-listing" style="background : #dfe4f4;">
[@{foreach name=outer item=table_data from=$table_data_list}@]
  [@{if (($smarty.foreach.outer.iteration-1)%3) == 0}@]
  <tr>
  [@{/if}@]     
    <td class="small-text" width="33%" valign="top"><table border="0" width="100%" cellspacing="1" cellpadding="2" class="product-listing" style="background : #ffffff; background-image : url('[@{$images_path}@]box-product-listing-b-background.jpg'); background-repeat : no-repeat; background-position: right bottom;">   
    [@{foreach name=inner item=data from=$table_data.table_inner}@]    
      <tr>
      [@{if $data.case == 'model'}@]<td nowrap="nowrap" class="small-text" valign="top">[@{if $data.products_model}@]<b>[@{#text_model#}@]&nbsp;</b>[@{$data.products_model}@][@{/if}@]</td>[@{/if}@]
      ...
      [@{if $data.case == 'info'}@]<td class="small-text" valign="top">[@{if $data.products_info}@]<b>[@{#text_brief_description#}@]</b><br />[@{$data.products_info}@][@{/if}@]</td>[@{/if}@]
      [@{if $data.case == 'packing_unit'}@]<td nowrap="nowrap" class="small-text" valign="top">[@{if $data.products_p_unit}@]<b>[@{#text_packing_unit#}@]&nbsp;</b>[@{$data.products_p_unit}@][@{/if}@]</td>[@{/if}@]
      [@{if $data.case == 'manufacturer'}@]<td nowrap="nowrap" class="small-text" valign="top">[@{if $data.manufacturers_name}@]<b>[@{#text_manufacturer#}@]&nbsp;</b><a href="[@{$data.manufacturers_link}@]"><span class="text-deco-underline">[@{$data.manufacturers_name}@]</span></a>[@{/if}@]</td>[@{/if}@]        
      [@{if $data.case == 'price'}@]
        <td class="small-text" valign="top">
        [@{if $data.price_breaks}@]
        <table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td colspan="2" nowrap="nowrap" class="small-text" valign="top"><b>[@{#text_price#}@]</b>&nbsp;</td>
          </tr>
          <tr>
            <td width="90%"></td>             
            <td class="price-label" align="right"><table border="0" cellspacing="0" cellpadding="0">             
              <tr>
                <td id="toggle_arrow_[@{$data.products_id}@]" nowrap="nowrap" align="right" class="small-text"><a><img onmouseover="this.style.cursor='pointer'" src="[@{$images_path}@]icon_arrow_down.gif" height="10" width="13" alt="" /></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td nowrap="nowrap" align="right" class="small-text"><b>[@{if $data.price_special}@]<span class="text-deco-line-through">[@{$data.price}@]</span> <span class="product-special-price">[@{$data.price_special}@]</span>[@{else}@][@{$data.price}@][@{/if}@]</b></td>
              </tr>
            </table></td>             
          </tr>
          <tr id="toggle_[@{$data.products_id}@]">
            <td width="90%"></td>
            <td class="price-label" align="right"><table border="0" width="100%" cellspacing="0" cellpadding="0">                
      ...
      [@{/if}@]    
      [@{if $data.case == 'quantity'}@]<td nowrap="nowrap" class="small-text" valign="top"><b>[@{#text_quantity#}@]&nbsp;</b>[@{$data.products_quantity}@]</td>[@{/if}@]
      [@{if $data.case == 'weight'}@]<td nowrap="nowrap" class="small-text" valign="top">[@{if $data.products_weight > 0}@]<b>[@{#text_weight#}@]&nbsp;</b>[@{$data.products_weight}@]kg[@{/if}@]</td>[@{/if}@]
      [@{if $data.case == 'image'}@]<td class="small-text" valign="top" align="center"><a href="[@{$data.products_link_image}@]">[@{$data.products_image_small}@]</a></td>[@{/if}@]
      [@{if $data.case == 'buy_now'}@]
        <td nowrap="nowrap" class="small-text" valign="top" align="right">
