...
<!-- contact_us -->
    [@{$form_begin}@]<table border="0" width="100%" cellspacing="0" cellpadding="0">
      ...
      [@{if $sent}@]      
      <tr>
        <td class="main" align="center"><img src="[@{$images_path}@]table_background.gif" alt="[@{$smarty.const.CONTACT_US_HEADING_TITLE}@]" title=" [@{$smarty.const.CONTACT_US_HEADING_TITLE}@] " align="left" />[@{$smarty.const.CONTACT_US_TEXT_SUCCESS}@]</td>
      </tr>
      <tr>
        <td><img src="[@{$images_path}@]pixel_trans.gif" alt="" width="100%" height="10" /></td>
      </tr>
          ...
          <tr class="info-box-central-contents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                ...
                <td nowrap="nowrap" class="main" align="right"><a href="[@{$link_filename_default}@]" class="button-continue" style="float: right" title=" [@{$smarty.const.CONTACT_US_BUTTON_TITLE_CONTINUE}@] "><span>[@{$smarty.const.CONTACT_US_BUTTON_TEXT_CONTINUE}@]</span></a></td>
                <td width="10"><img src="[@{$images_path}@]pixel_trans.gif" alt="" width="10" height="1" /></td>
              </tr>
            </table></td>
          </tr>
