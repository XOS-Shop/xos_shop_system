...
<body>                              
  ...
  <table class="product-listing" style="width:10%; padding-left:20px; padding-top:20px; padding-right:20px; padding-bottom:20px;"> 
    <tr>
      <td align="right">                                                                    
      ...
      <td align="right">                             
        <table border="0" width="100%" cellspacing="1" cellpadding="0">
          ...
          [@{if $stock_check == 'true'}@]
            ...
            <td width="95%" nowrap="nowrap" class="small-text" valign="top" align="right">[@{#text_is_not_offered#}@]&nbsp;&nbsp;&nbsp;<br />[@{#text_will_be_reordered#}@]&nbsp;&nbsp;&nbsp;</td>
            <td nowrap="nowrap" class="small-text" valign="top" align="center"><span class="red-mark" style="font-weight : bold;">X</span><br /><span class="red-mark" style="font-weight : bold;">0/-1/-2/...</span></td>
            [@{else}@]                              
            <td width="95%" nowrap="nowrap" class="small-text" valign="top" align="right">[@{#text_is_not_offered#}@]&nbsp;&nbsp;&nbsp;<span class="red-mark" style="font-weight : bold;">X</span><br />[@{#text_sold_out#}@]&nbsp;&nbsp;&nbsp;<span class="red-mark" style="font-weight : bold;">0</span></td>
            <td nowrap="nowrap" class="small-text" valign="top" align="right">&nbsp;&nbsp;&nbsp;</td>                         
            [@{/if}@]
          [@{else}@]
            <td width="98%" nowrap="nowrap" class="small-text" valign="top" align="right">[@{#text_is_offered#}@]&nbsp;&nbsp;&nbsp;<img src="[@{$images_path}@]tick.gif" alt="" /><br />[@{#text_is_not_offered#}@]&nbsp;&nbsp;&nbsp;<img src="[@{$images_path}@]cross.gif" alt="" /></td>
            <td nowrap="nowrap" class="small-text" valign="top" align="right">&nbsp;&nbsp;&nbsp;</td> 
          [@{/if}@]
          </tr>                                                                                                                     
        </table>                                                                                                                                                                            
