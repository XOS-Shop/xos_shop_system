              ...
              <ul id="shopping_cart_list" class="dropdown-menu" role="menu">
                <li>        
                  [@{if $products_quantity_total == 0}@]
                    <div style="width:120px; padding: 11px 3px 11px 3px; float: right; background-color: #000000;">[@{#box_shopping_cart_empty#}@]</div>
                  [@{else}@]
                    <div id="shopping_cart_box_content" style="width: 220px; padding: 11px 3px 3px 3px; text-align: left; float: right; background-color: #000000;">
                    <div id="shopping_cart_box_title" style="text-align: left; vertical-align: top; display:none;"><b>[@{#box_product_has_been_added#}@]<br />&nbsp;</b></div>
                      ...
                      <div style="padding: 2px 0 1px 0;"><img src="[@{$images_path}@]pixel_white.gif" alt="" style="display: block; width: 100%; height: 1px;" /></div>
