...
* filename   : password_forgotten_email_html.tpl
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="2">
      ...
      <tr>
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td nowrap="nowrap" style="font-family: Verdana, Arial, sans-serif; font-size: 12px;">[@{eval var=#html_email_password_reminder_body_1#}@]</td>
          </tr>
          <tr>
            <td nowrap="nowrap" style="font-family: Verdana, Arial, sans-serif; font-size: 12px;">[@{eval var=#html_email_password_reminder_body_2#}@] <b>[@{$new_password}@]</b></td>
          </tr>
        </table></td>
      </tr>
    </table></td>
