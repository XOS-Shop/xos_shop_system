        ...
        switch ($column_list[$col]) {
          ...
          case 'PRODUCT_LIST_BUY_NOW':
            $table_inner_array[]=array('case' => 'buy_now',
                                       ...
                                       'products_input_quantity' => xos_draw_input_field('products_quantity', '1','id="products_quantity_' . $listing['products_id'] . '" style="width:40px;" class="form-control" maxlength="5"'),
