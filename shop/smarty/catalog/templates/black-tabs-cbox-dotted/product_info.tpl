                ...
                <div id="info-images">
                         [@{foreach name=images item=product_image from=$products_images}@]
                           [@{if $smarty.foreach.images.total > 1}@]                        
                            <script  type="text/javascript">
                            /* <![CDATA[ */
                              document.write('<span class="info"><a id="info[@{$product_image.i}@]" class="jqzoom" href="[@{$product_image.href_to_product_img_large}@]" onclick="return false">[@{$product_image.product_img_medium}@]</a></span><a id="glass[@{$product_image.i}@]" class="glass" href="[@{$product_image.href_to_product_img_large}@]" rel="images_group" target="_blank"><img align="right" src="[@{$images_path}@]magnifying_glass.gif" alt="[@{#text_click_to_enlarge#}@]" title=" [@{#text_click_to_enlarge#}@] " /></a>')                          
                            /* ]]> */  
                            </script>
                            <noscript>
...
/* ]]> */   
            ...
            <div class="info-box-central-contents" style="background : #feffff; padding: 0 10px 0 3px;">            
