          ...
          <table border="0" width="100%" cellspacing="0" cellpadding="2" class="product-listing-cart">
            <tr>
             [@{if $tax_groups}@]
              ...
              <td width="5%" align="center" class="product-listing-cart-heading" nowrap="nowrap">&nbsp; [@{#table_heading_quantity#}@]</td>
              <td width="12%" align="center" class="product-listing-cart-heading" nowrap="nowrap">&nbsp;</td>              
             ...
             [@{else}@]
              ...
              <td width="71%" align="right" class="product-listing-cart-heading" nowrap="nowrap">[@{#table_heading_price#}@]</td>
              <td width="5%" align="center" class="product-listing-cart-heading" nowrap="nowrap">&nbsp; [@{#table_heading_quantity#}@]</td>
              <td width="12%" align="center" class="product-listing-cart-heading" nowrap="nowrap">&nbsp;</td>              
              <td width="2%" align="right" class="product-listing-cart-heading" nowrap="nowrap">[@{#table_heading_total#}@]</td>             
             [@{/if}@] 
            ...
            [@{/if}@]
              <td colspan="[@{if $tax_groups}@]8[@{else}@]7[@{/if}@]"><img src="[@{$images_path}@]pixel_trans.gif" alt="" width="100%" height="1" /></td>              
            </tr>                                    
            [@{if (($smarty.foreach.outer.iteration-1)%2) == 0}@]
            <tr class="product-listing-cart-odd">
            [@{else}@]
            ...
            [@{/if}@]
              ...
              <td colspan="[@{if $tax_groups}@]7[@{else}@]6[@{/if}@]" class="product-listing-cart-data" nowrap="nowrap">&nbsp;&nbsp;&nbsp;<a href="[@{$product.link_filename_product_info}@]">[@{$product.products_image}@]</a></td>              
            </tr>                       
            [@{if (($smarty.foreach.outer.iteration-1)%2) == 0}@]
            <tr class="product-listing-cart-odd">
            [@{else}@]
            ...
            [@{/if}@]            
              ...
              <td valign="bottom" class="product-listing-cart-data" nowrap="nowrap"><input type="image" src="[@{$images_path}@]update.png" alt="[@{#text_update_product#}@]" title=" [@{#text_update_product#}@] " style="margin: 0" /><a href="[@{$product.link_remove_product}@]"><img src="[@{$images_path}@]trash_can.png" alt="[@{#text_remove_product#}@]" title=" [@{#text_remove_product#}@] " style="margin: 0 20px 0 5px" /></a><br /><img src="[@{$images_path}@]pixel_trans.gif" alt="" width="100%" height="2" /></td>
            ...
            <tr class="product-listing-cart-even">
            [@{/if}@]
              <td colspan="[@{if $tax_groups}@]8[@{else}@]7[@{/if}@]" class="product-listing-cart-data-last" [@{if !$smarty.foreach.outer.last}@]style="border-bottom: 1px dashed #b6b7cb;"[@{/if}@]><img src="[@{$images_path}@]pixel_trans.gif" alt="" width="100%" height="6" /></td>              
            </tr>                                    
            [@{/foreach}@]
          </table>
          <div style="height: 10px; font-size: 0;">&nbsp;</div>
