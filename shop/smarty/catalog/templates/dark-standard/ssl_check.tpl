...
<!-- ssl_check -->
          <h1 class="page-heading" style="line-height: [@{#page_heading_height#}@]px; padding: 0 0 10px 0">[@{#heading_title#}@]</h1> 
          <div style="height: 10px; font-size: 0;">&nbsp;</div>
          <div  class="main">           
            <div style="padding: 0 0 4px 4px; width: 40%; float: right;">  
              <h3 class="info-box-heading-central-contents">[@{#box_information_heading#}@]</h3>
          ...
          <div class="info-box-central-contents">                             
            <div class="main" style="margin: 4px 15px 4px 15px;">                      
              <a href="[@{$link_filename_login}@]" class="button-continue" style="float: right" title=" [@{#button_title_continue#}@] "><span>[@{#button_text_continue#}@]</span></a>
              <div class="clear">&nbsp;</div>                    
            </div>             
          </div>
<!-- ssl_check_eof -->
