...
jQuery(document).ready(function($) {
                      if(!(typeof document.body.style.maxHeight === 'undefined') && !(navigator.userAgent.toLowerCase().indexOf('konqueror') > -1)) {  // is not IE6 and not Konqueror
                        ...
                        $('.main-cat').mouseenter(function(){                
                          $(this).children('ul').css({'border-radius' : '10px', '-moz-border-radius' : '10px', '-webkit-border-radius' : '10px', 'box-shadow' : '3px 3px 7px #333333', '-moz-box-shadow' : '3px 3px 7px #333333', '-webkit-box-shadow' : '3px 3px 7px #333333'}).show(200); 
                        }).mouseleave(function(){
