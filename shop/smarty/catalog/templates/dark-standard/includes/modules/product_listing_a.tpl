...
[@{if $listing}@]
          ...
          <div>           
            ...
            <div class="small-text" style="float: left; padding: 3px;">                       
              <label for="[@{$label_for_max_display_products}@]"><b>[@{#text_products_per_page#}@]</b></label>     
              <div class="small-text" style="padding: 4px 20px 0 0; white-space: nowrap;">
                <script type="text/javascript">
                /* <![CDATA[ */
            ...
            [@{if $pull_down_menu}@]          
            <div class="small-text" style="float: left; padding: 3px;">                       
              <label for="[@{$label_for_pull_down_menu}@]"><b>[@{#text_show#}@]</b></label>     
              <div class="small-text" style="padding: 4px 20px 0 0; white-space: nowrap;">
                <script type="text/javascript">
                /* <![CDATA[ */
          ...
          [@{if $nav_bar_top}@]
          <div class="small-text" style="line-height: 22px; float: left; padding: 2px; white-space: nowrap;">[@{$nav_bar_number}@]</div>
          <div class="small-text" style="line-height: 22px; float: right; padding: 2px; white-space: nowrap;">
            <script type="text/javascript">
            /* <![CDATA[ */
...
<table border="0" width="100%" cellspacing="0" cellpadding="2">
  <tr>
    ...
    [@{if $heading.case == 'model'}@]<th nowrap="nowrap" class="product-listing-heading">&nbsp;[@{$heading.text}@]&nbsp;</th>[@{/if}@]
    [@{if $heading.case == 'name'}@]<th nowrap="nowrap" class="product-listing-heading">&nbsp;[@{$heading.text}@]&nbsp;</th>[@{/if}@]
    [@{if $heading.case == 'info'}@]<th nowrap="nowrap" class="product-listing-heading">&nbsp;[@{$heading.text}@]&nbsp;</th>[@{/if}@]
    [@{if $heading.case == 'packing_unit'}@]<th nowrap="nowrap" class="product-listing-heading">&nbsp;[@{$heading.text}@]&nbsp;</th>[@{/if}@]
    [@{if $heading.case == 'manufacturer'}@]<th nowrap="nowrap" class="product-listing-heading">&nbsp;[@{$heading.text}@]&nbsp;</th>[@{/if}@]
    [@{if $heading.case == 'price'}@]<th nowrap="nowrap" class="product-listing-heading" style="text-align: right;">&nbsp;[@{$heading.text}@]&nbsp;</th>[@{/if}@]
    [@{if $heading.case == 'quantity'}@]<th nowrap="nowrap" class="product-listing-heading" style="text-align: right;">&nbsp;[@{$heading.text}@]&nbsp;</th>[@{/if}@]
    [@{if $heading.case == 'weight'}@]<th nowrap="nowrap" class="product-listing-heading" style="text-align: right;">&nbsp;[@{$heading.text}@]&nbsp;</th>[@{/if}@]
    [@{if $heading.case == 'image'}@]<th nowrap="nowrap" class="product-listing-heading" style="text-align: right;">&nbsp;[@{$heading.text}@]&nbsp;</th>[@{/if}@]
    [@{if $heading.case == 'buy_now'}@]<th nowrap="nowrap" class="product-listing-heading" style="text-align: right;">&nbsp;[@{$heading.text}@]&nbsp;</th>[@{/if}@]
    [@{/foreach}@]
  </tr>
  ...
  [@{/if}@]
    ...
    [@{if $data.case == 'name'}@]<td class="product-listing-data" style="padding: 0 6px 0 6px;"><h3 class="h3-product-listing-data"><a href="[@{$data.products_link}@]">[@{$data.products_name}@]</a></h3></td>[@{/if}@]
                        ...
                        <div class="rb-price-label">
                          <div class="lb-price-label">
                            <div class="box-content-price-label">  
                              <div id="toggle_arrow_[@{$data.products_id}@]" class="price-label small-text" style="padding: 1px; text-align: right; white-space: nowrap;"><a><img onmouseover="this.style.cursor='pointer'" src="[@{$images_path}@]icon_arrow_down.gif" height="10" width="13" alt="[@{#more#}@]" title=" [@{#more#}@] " /></a>&nbsp;&nbsp;&nbsp;&nbsp;<b>[@{if $data.price_special}@]<span class="text-deco-line-through">[@{$data.price}@]</span> <span class="product-special-price">[@{$data.price_special}@]</span>[@{else}@][@{$data.price}@][@{/if}@]</b></div>
                              <div>  
                                <div id="toggle_[@{$data.products_id}@]" style="padding: 1px; float: right;">
                ...
                <div>
	              ...
	              <div class="lt-price-label">
                        <div class="rb-price-label">
                          <div class="lb-price-label">
                            <div class="box-content-price-label">                                                                                
                              <div class="price-label small-text" style="padding: 1px; text-align: right; white-space: nowrap;"><b>[@{if $data.price_special}@]<span class="text-deco-line-through">[@{$data.price}@]</span> <span class="product-special-price">[@{$data.price_special}@]</span>[@{else}@][@{$data.price}@][@{/if}@]</b></div>
                              <div class="price-label small-text" style="padding: 1px; text-align: right; white-space: nowrap;">
                                [@{$data.tax_description|replace:'SMARTY_TAX_WITHOUT_VAT':#text_tax_without_vat#|replace:'SMARTY_TAX_NO_VAT':#text_tax_no_vat#|replace:'SMARTY_TAX_INC_VAT':#text_tax_inc_vat#|replace:'SMARTY_TAX_PLUS_VAT':#text_tax_plus_vat#}@]<br />              
                                [@{if $link_filename_popup_content_5}@]                 
                                  <script type="text/javascript">
    ...
    [@{if $data.case == 'buy_now'}@]
      <td nowrap="nowrap" align="right" class="product-listing-data">
        [@{$data.products_buy_form_begin}@]<span class="hidden"><label for="[@{$data.label_for_products_input_quantity}@]">[@{#text_quantity_in_hidden_field#}@]</label></span>[@{$data.products_hidden_field}@][@{$data.products_input_quantity}@]<br />
        <script type="text/javascript">
        /* <![CDATA[ */
  ...
  [@{/if}@]
    ...
    [@{if $data.case == 'name'}@]<td class="product-listing-data-last" style="padding: 0 6px 0 6px;"><h3 class="h3-product-listing-data"><a href="[@{$data.products_link}@]">[@{$data.products_name}@]</a></h3></td>[@{/if}@]
