...
<!-- new_products -->
          <h3 class="info-box-heading-central-contents">[@{#table_heading_new_products#}@]</h3>
          <div class="info-box-central-contents">
            ...
            <div class="small-text" style="overflow: hidden; padding: 4px; text-align: center; float: left; width: 32%">
              <div style="border: solid 1px #b6b7cb; background : #ffffff">
                <br />
                <h4 class="main" style="background : #e8e8e8; padding : 5px; margin :  0px 5px 10px 5px; font-weight: bold"><a href="[@{$new_product.link_filename_product_info}@]">[@{$new_product.name}@]</a></h4><a href="[@{$new_product.link_filename_product_info}@]">[@{$new_product.image}@]</a><br /><br />
