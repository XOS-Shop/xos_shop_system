              ...
              <div class="rb">
                <div class="lb">
                  <div class="box-content">
                    <h3 class="info-box-heading"><a href="[@{$box_whats_new_link_filename_products_new}@]"><img src="[@{$images_path}@]arrow_right.gif" alt="[@{#more#}@]" title=" [@{#more#}@] " />[@{#box_heading_whats_new#}@]</a></h3>
