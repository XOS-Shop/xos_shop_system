...
<!-- advanced_search_and_results -->
          ...
          <h1 class="page-heading" style="line-height: [@{#page_heading_height#}@]px;">[@{#heading_title_1#}@]</h1>        
          ...
          <fieldset>
          <div class="info-box-heading-central-contents"><label for="keywords">[@{#heading_search_criteria#}@]</label></div>
          ...
          <div class="small-text" style="padding: 0 0 0 1px; float: left;">
          ...
          <div class="small-text" style="padding: 0 1px 0 0;">
              <a href="[@{$link_filename_advanced_search_and_results}@]" class="button-reset" style="float: right" title=" [@{#button_title_reset#}@] "><span>[@{#button_text_reset#}@]</span></a>                                   
              <script type="text/javascript">
              /* <![CDATA[ */
                document.write('<a href="" onclick="if(advanced_search_and_results.onsubmit())advanced_search_and_results.submit(); return false" class="button-search" style="margin-right: 15px; float: right" title=" [@{#button_title_search#}@] "><span>[@{#button_text_search#}@]</span></a><input type="image" src="[@{$images_path}@]pixel_trans.gif" alt="" />')
              /* ]]> */  
              </script>
              <noscript>
                <input style="margin-right: 15px; float: right" type="submit" value="[@{#button_text_search#}@]" />
              </noscript>
          </div>
          <div class="clear">&nbsp;</div>                                                                                 
          ...
          [@{$form_end}@]          
          <h2 id="advanced-search-and-results-heading" class="page-heading" style="line-height: [@{#page_heading_height#}@]px;">[@{#heading_title_2#}@]</h2>
<script type="text/javascript">
/* <![CDATA[ */
