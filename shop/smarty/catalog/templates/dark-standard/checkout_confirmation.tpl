...
<!-- checkout_confirmation -->
    [@{$form_begin}@]
          ...
          <div class="info-box-central-contents"> 
            <div>                           
                <table border="0" cellspacing="0" cellpadding="2">        
                  <tr>
                   [@{if $tax_groups}@]
                    <th width="20%" nowrap="nowrap" class="product-listing-checkout-confirmation-heading">[@{#table_heading_products_model#}@]</th>
                    <th width="8%" nowrap="nowrap" class="product-listing-checkout-confirmation-heading" colspan="2">[@{#table_heading_products#}@]</th>       
                    <th width="32%" nowrap="nowrap" class="product-listing-checkout-confirmation-heading" style="text-align: right;">[@{#table_heading_tax#}@]</th>    
                    <th width="1%" nowrap="nowrap" class="product-listing-checkout-confirmation-heading">&nbsp;</th>
                    <th width="20%" nowrap="nowrap" class="product-listing-checkout-confirmation-heading" style="text-align: right;">[@{#table_heading_price#}@]</th>
                    <th width="1%" nowrap="nowrap" class="product-listing-checkout-confirmation-heading">&nbsp;</th>
                    <th width="15%" nowrap="nowrap" class="product-listing-checkout-confirmation-heading" style="text-align: center;">[@{#table_heading_quantity#}@]</th>
                    <th width="1%" nowrap="nowrap" class="product-listing-checkout-confirmation-heading">&nbsp;</th>
                    <th width="2%" nowrap="nowrap" class="product-listing-checkout-confirmation-heading" style="text-align: right;">[@{#table_heading_total#}@]</th>
                   [@{else}@] 
                    <th width="20%" nowrap="nowrap" class="product-listing-checkout-confirmation-heading">[@{#table_heading_products_model#}@]</th>
                    <th width="8%" nowrap="nowrap" class="product-listing-checkout-confirmation-heading" colspan="2">[@{#table_heading_products#}@]</th>
                    <th width="53%" nowrap="nowrap" class="product-listing-checkout-confirmation-heading" style="text-align: right;">[@{#table_heading_price#}@]</th>
                    <th width="1%" nowrap="nowrap" class="product-listing-checkout-confirmation-heading">&nbsp;</th>
                    <th width="15%" nowrap="nowrap" class="product-listing-checkout-confirmation-heading" style="text-align: center;">[@{#table_heading_quantity#}@]</th>
                    <th width="1%" nowrap="nowrap" class="product-listing-checkout-confirmation-heading">&nbsp;</th>
                    <th width="2%" nowrap="nowrap" class="product-listing-checkout-confirmation-heading" style="text-align: right;">[@{#table_heading_total#}@]</th>            
     ...
     [@{if $link_filename_popup_content_8}@]
          ...
          <div style="height: 10px; font-size: 0;">&nbsp;</div>                  
     [@{/if}@]      
          <div class="main">[@{$input_process_button}@]     
            <script type="text/javascript">
            /* <![CDATA[ */
