...
<!-- account_history_info -->
          ...
          <h3 class="main"><b>[@{eval var=#heading_order_number#}@] <small>([@{$orders_status}@])</small></b></h3>
          ...
          <div style="height: 10px; font-size: 0;">&nbsp;</div>        
          <h3 class="main"><b>[@{#heading_ordered_products#}@]</b></h3>      
          <div class="info-box-central-contents"> 
            <div>                
                <table border="0" cellspacing="0" cellpadding="2">        
                  <tr>
                   [@{if $tax_groups}@]
                    <th width="20%" nowrap="nowrap" class="product-listing-account-history-info-heading">[@{#table_heading_products_model#}@]</th>
                    <th width="8%" nowrap="nowrap" class="product-listing-account-history-info-heading" colspan="2">[@{#table_heading_products#}@]</th>       
                    <th width="32%" nowrap="nowrap" class="product-listing-account-history-info-heading" style="text-align: right;">[@{#table_heading_tax#}@]</th>    
                    <th width="1%" nowrap="nowrap" class="product-listing-account-history-info-heading">&nbsp;</th>
                    <th width="20%" nowrap="nowrap" class="product-listing-account-history-info-heading" style="text-align: right;">[@{#table_heading_price#}@]</th>
                    <th width="1%" nowrap="nowrap" class="product-listing-account-history-info-heading">&nbsp;</th>
                    <th width="15%" nowrap="nowrap" class="product-listing-account-history-info-heading" style="text-align: center;">[@{#table_heading_quantity#}@]</th>
                    <th width="1%" nowrap="nowrap" class="product-listing-account-history-info-heading">&nbsp;</th>
                    <th width="2%" nowrap="nowrap" class="product-listing-account-history-info-heading" style="text-align: right;">[@{#table_heading_total#}@]</th>
                   [@{else}@] 
                    <th width="20%" nowrap="nowrap" class="product-listing-account-history-info-heading">[@{#table_heading_products_model#}@]</th>
                    <th width="8%" nowrap="nowrap" class="product-listing-account-history-info-heading" colspan="2">[@{#table_heading_products#}@]</th>
                    <th width="53%" nowrap="nowrap" class="product-listing-account-history-info-heading" style="text-align: right;">[@{#table_heading_price#}@]</th>
                    <th width="1%" nowrap="nowrap" class="product-listing-account-history-info-heading">&nbsp;</th>
                    <th width="15%" nowrap="nowrap" class="product-listing-account-history-info-heading" style="text-align: center;">[@{#table_heading_quantity#}@]</th>
                    <th width="1%" nowrap="nowrap" class="product-listing-account-history-info-heading">&nbsp;</th>
                    <th width="2%" nowrap="nowrap" class="product-listing-account-history-info-heading" style="text-align: right;">[@{#table_heading_total#}@]</th>            
          ...
          <div style="height: 10px; font-size: 0;">&nbsp;</div>
          <h3 class="main"><b>[@{#heading_order_history#}@]</b></h3>        
          <div class="info-box-central-contents"> 
