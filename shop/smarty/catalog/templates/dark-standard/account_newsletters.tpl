...
<!-- account_newsletters -->
    [@{$form_begin}@][@{$hidden_field}@]
          ...
          <h3 class="main"><b>[@{#my_newsletters_title#}@]</b></h3>
          <div class="info-box-central-contents" style="padding: 2px 12px 2px 12px;">            
            <div class="module-row" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)" onclick="checkBox('newsletter_general')">
              <div class="main" style="padding: 4px;">[@{$checkbox_field}@]&nbsp;<b>[@{#my_newsletters_general_newsletter#}@]</b><span class="hidden"><label for="checkbox_newsletter_general">[@{#my_newsletters_general_newsletter#}@]</label></span></div>
            </div>
