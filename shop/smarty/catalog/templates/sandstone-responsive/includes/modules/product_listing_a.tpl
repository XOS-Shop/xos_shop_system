    ...
    return false;
          ...
          <div>          
            ...
            <div style="float: left; padding: 3px;">                       
              ...
              <div style="padding: 2px 20px 0 0; white-space: nowrap;">
                <a href="[@{$link_switch_view}@]" class="btn btn-default" style="float: left" title=" [@{#button_title_switch_view#}@] "><span class="glyphicon glyphicon-align-justify"  style="color:red;"></span> <span class="glyphicon glyphicon-th"  style="color:grey;"></span> [@{#button_text_switch_view#}@]</a>                       
              </div>                                   
            </div> 
            [@{/if}@]           
            ...
            <div id="sort">
              ...
              <div style="padding: 2px 20px 0 0;"> 
                <div id="sort_box">
                  [@{if $selected_none}@]
                  <ul style="padding: 9px; border-radius: 4px;">
          ...
          <div class="panel panel-default clearfix">           
            <div class="panel-body">
              <div class="row">
                [@{if $product_image}@]                        
                [@{if $product_info}@]<div class="col-sm-3 col-md-3">[@{else}@]<div class="col-sm-3 col-md-4">[@{/if}@]
                [@{foreach name=inner1 item=data from=$table_data.table_inner}@]
                  [@{if $data.case == 'name'}@]
                ...
                [@{if $product_info}@]<div class="col-sm-5 col-md-3">[@{else}@]<div class="col-sm-5 col-md-4">[@{/if}@]
                [@{foreach name=inner2 item=data from=$table_data.table_inner}@]
                ...
                [@{else}@]
                [@{if $product_info}@]<div class="col-sm-6 col-md-4">[@{else}@]<div class="col-sm-8 col-md-8">[@{/if}@]
                [@{foreach name=inner2 item=data from=$table_data.table_inner}@]
                  [@{if $data.case == 'name'}@]<div class="product-listing-b-item-data"><b><a href="[@{$data.products_link}@]"><span class="text-deco-underline">[@{$data.products_name}@]</span></a></b></div>[@{/if}@]
                  [@{if $data.case == 'model'}@]<div class="product-listing-b-item-data">[@{if $data.products_model}@]<b>[@{#text_model#}@] </b>[@{$data.products_model}@][@{/if}@]</div>[@{/if}@]
                  [@{if $data.case == 'manufacturer'}@]<div class="product-listing-b-item-data">[@{if $data.manufacturers_name}@]<b>[@{#text_manufacturer#}@] </b><a href="[@{$data.manufacturers_link}@]"><span class="text-deco-underline">[@{$data.manufacturers_name}@]</span></a>[@{/if}@]</div>[@{/if}@]    
                  [@{if $data.case == 'quantity'}@]<div class="product-listing-b-item-data"><b>[@{#text_quantity#}@] </b>[@{$data.products_quantity}@]</div>[@{/if}@]
                  [@{if $data.case == 'weight'}@]<div class="product-listing-b-item-data">[@{if $data.products_weight > 0}@]<b>[@{#text_weight#}@] </b>[@{$data.products_weight}@]kg[@{/if}@]</div>[@{/if}@]
                ...
                [@{/if}@]
                [@{if $product_info}@]
                [@{if $product_image}@]<div class="col-sm-4 col-md-3">[@{else}@]<div class="col-sm-6 col-md-4">[@{/if}@]
                [@{foreach name=inner3 item=data from=$table_data.table_inner}@]
                ...
                [@{/if}@]
                [@{if $product_image}@][@{if $product_info}@]<div class="col-sm-12 col-md-3">[@{else}@]<div class="col-sm-4 col-md-4">[@{/if}@][@{else}@][@{if $product_info}@]<div class="col-sm-12 col-md-4">[@{else}@]<div class="col-sm-4 col-md-4">[@{/if}@][@{/if}@]
                [@{foreach name=inner4 item=data from=$table_data.table_inner}@]    
                  [@{if $data.case == 'price'}@]
