...
<!-- products_new -->
        ...
        [@{if $new_products}@]       
          ...
          <div style="padding: 4px; width: 98%; border: solid 1px #b6b7cb; border-radius: 10px;">
                  ...
                  <td style="text-align: right;">                                                                        
                    ...
                    <div class="price-label main" style="padding: 0 2px 0 2px;">
                      <table class="price-label table-border-cellspacing cellpadding-0px" style="float: right;">                     
                        ...
                        [@{/if}@]                                
                        <tr>   
                          <td class="main" style="white-space: nowrap; text-align: right; vertical-align: top;">[@{$price_break.qty}@]<sup>+</sup>&nbsp;&nbsp;&nbsp;</td>                
                          <td class="main" style="white-space: nowrap; text-align: right; vertical-align: top;"><b>[@{if $price_break.price_break_special}@]<span class="text-deco-line-through">[@{$price_break.price_break}@]</span> <span class="product-special-price">[@{$price_break.price_break_special}@]</span>[@{else}@][@{$price_break.price_break}@][@{/if}@]</b></td>
                        </tr>                                                 
                        [@{/foreach}@] 
                      </table>                 
                    </div>
