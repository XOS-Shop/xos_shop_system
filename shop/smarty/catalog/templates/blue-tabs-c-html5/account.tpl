            ...
            <div class="main" style="width: 78%;padding: 2px 2px 2px 2px; float: right;">              
              ...
              [@{foreach item=order from=$orders}@]                
                <tr class="module-row" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)" onclick="document.location.href='[@{$order.link_filename_account_history_info}@]'">
                  <td class="main" style="white-space: nowrap;">#[@{$order.order_id}@]&nbsp;&nbsp;</td>
                  <td class="main" style="white-space: nowrap; width: 80px;">[@{$order.date_purchased}@]</td>                    
                  <td class="main">[@{$order.order_name}@], [@{$order.order_country}@]</td>
                  <td class="main" style="white-space: nowrap;">&nbsp;[@{$order.order_status_name}@]&nbsp;</td>
                  <td class="main" style="white-space: nowrap; text-align: right;">[@{$order.order_total}@]</td>                    
                  <td class="main" style="white-space: nowrap; text-align: right;"><a href="[@{$order.link_filename_account_history_info}@]" class="button-small-view" style="float: right" title=" [@{#small_button_title_view#}@] "><span>[@{#small_button_text_view#}@]</span></a></td>                    
                </tr>
              [@{/foreach}@]  
              </table>                            
            </div>
          ...
          <div class="info-box-central-contents">
            ...
            <div class="main" style="width: 540px; padding: 2px 2px 2px 2px; float: left;">                    
              <table class="table-border-cellspacing cellpadding-0px" style="width: 100%;">
                <tr>
                  <td style="height: 65px;"><table class="table-border-cellspacing cellpadding-2px" style="width: 100%;">
