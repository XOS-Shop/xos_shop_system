...
<div style="padding: 2px 0 0 0;">
  <div>    
    <div style="width: 817px; float: left;">            
      <div class="header-outer" style="height: 72px;"><div style="padding: 29px 4px 0 0; white-space:nowrap; text-align: right; float: right;">[@{if $is_shop}@][@{if $header_link_filename_logoff}@]<a href="[@{$header_link_filename_logoff}@]" class="header" style="display: block;">[@{#header_title_logoff#}@]</a>[@{/if}@][@{/if}@]</div><img src="[@{$images_path}@]pixel_trans.gif" alt="" width="5" height="5" /></div>
      <div>
        [@{$box_tabs}@]
      </div>      
