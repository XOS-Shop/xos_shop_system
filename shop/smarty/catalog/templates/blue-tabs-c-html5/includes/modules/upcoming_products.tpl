...
<!-- upcoming_products -->
            <div>
              ...
              <div class="clear">&nbsp;</div>
              <div style="padding: 2px;"><img src="[@{$images_path}@]pixel_black.gif" alt="" style="display: block; width: 100%; height: 1px;" /></div>
              [@{foreach name=loop item=upcoming_product from=$upcoming_products}@]
              [@{if (($smarty.foreach.loop.iteration-1)%2) == 0}@]
              <div class="small-text" style="background : #dfe4f4; padding: 3px; white-space: nowrap;">
              [@{else}@]
