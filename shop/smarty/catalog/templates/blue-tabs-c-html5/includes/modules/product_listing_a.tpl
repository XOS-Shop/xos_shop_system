...
<table class="table-border-cellspacing cellpadding-2px product-listing" style="width: 100%;">
  <tr>
    [@{foreach item=heading from=$table_heading}@]
    [@{if $heading.case == 'model'}@]<td class="product-listing-heading" style="white-space: nowrap;">&nbsp;[@{$heading.text}@]&nbsp;</td>[@{/if}@]
    [@{if $heading.case == 'name'}@]<td class="product-listing-heading" style="white-space: nowrap;">&nbsp;[@{$heading.text}@]&nbsp;</td>[@{/if}@]
    [@{if $heading.case == 'info'}@]<td class="product-listing-heading" style="white-space: nowrap;">&nbsp;[@{$heading.text}@]&nbsp;</td>[@{/if}@]
    [@{if $heading.case == 'packing_unit'}@]<td class="product-listing-heading" style="white-space: nowrap;">&nbsp;[@{$heading.text}@]&nbsp;</td>[@{/if}@]
    [@{if $heading.case == 'manufacturer'}@]<td class="product-listing-heading" style="white-space: nowrap;">&nbsp;[@{$heading.text}@]&nbsp;</td>[@{/if}@]
    [@{if $heading.case == 'price'}@]<td class="product-listing-heading" style="white-space: nowrap; text-align: right;">&nbsp;[@{$heading.text}@]&nbsp;</td>[@{/if}@]
    [@{if $heading.case == 'quantity'}@]<td class="product-listing-heading" style="white-space: nowrap; text-align: right;">&nbsp;[@{$heading.text}@]&nbsp;</td>[@{/if}@]
    [@{if $heading.case == 'weight'}@]<td class="product-listing-heading" style="white-space: nowrap; text-align: right;">&nbsp;[@{$heading.text}@]&nbsp;</td>[@{/if}@]
    [@{if $heading.case == 'image'}@]<td class="product-listing-heading" style="white-space: nowrap; text-align: center;">&nbsp;[@{$heading.text}@]&nbsp;</td>[@{/if}@]
    [@{if $heading.case == 'buy_now'}@]<td class="product-listing-heading" style="white-space: nowrap; text-align: right;">&nbsp;[@{$heading.text}@]&nbsp;</td>[@{/if}@]
    [@{/foreach}@]
  </tr>
  ...
  [@{/if}@]
                  ...
                  <div style="float: right;">
                    ...
                    <div class="price-label small-text">  
                      ...
                      <table class="table-border-cellspacing cellpadding-0px">                
                        ...
                        <tr>                       
                          <td colspan="2" class="small-text" style="white-space: nowrap; text-align: center; vertical-align: bottom;"><img src="[@{$images_path}@]pixel_trans.gif" alt="" style="display: block; width: 100%; height: 4px;" />[@{#text_price_breaks#}@]<img src="[@{$images_path}@]pixel_black.gif" alt="" style="display: block; width: 100%; height: 1px;" /></td>
                        </tr>                      
                        <tr>
                          <td class="small-text" style="white-space: nowrap; text-align: right; vertical-align: top;">[@{#text_quantity_in_price_breaks#}@]</td>
                          <td class="small-text" style="white-space: nowrap; text-align: center; vertical-align: top;">[@{#text_price_in_price_breaks#}@]</td>
                        </tr>                                                                   
                        [@{/if}@]                                                     
                        <tr>
                          <td class="small-text" style="white-space: nowrap; text-align: right;">[@{$price_breaks.qty}@]<sup>+</sup>&nbsp;&nbsp;</td>
                          <td class="small-text" style="white-space: nowrap; text-align: right;"><b>[@{if $price_breaks.price_break_special}@]<span class="text-deco-line-through">[@{$price_breaks.price_break}@]</span> <span class="product-special-price">[@{$price_breaks.price_break_special}@]</span>[@{else}@][@{$price_breaks.price_break}@][@{/if}@]</b></td>
                        </tr>                 
                        [@{/foreach}@]                
                      </table>
                      </div>
    ...
    [@{/if}@]                           
    [@{if $data.case == 'quantity'}@]<td class="product-listing-data" style="text-align: center;">&nbsp;[@{$data.products_quantity}@]&nbsp;</td>[@{/if}@]
    [@{if $data.case == 'weight'}@]<td class="product-listing-data" style="text-align: right;">&nbsp;[@{$data.products_weight}@]kg&nbsp;</td>[@{/if}@]
    [@{if $data.case == 'image'}@]<td class="product-listing-data" style="text-align: center;">&nbsp;<a href="[@{$data.products_link_image}@]">[@{$data.products_image_small}@]</a>&nbsp;</td>[@{/if}@]    
    [@{if $data.case == 'buy_now'}@]
      <td class="product-listing-data" style="white-space: nowrap; text-align: right;">
        [@{$data.products_buy_form_begin}@][@{$data.products_hidden_field}@][@{$data.products_input_quantity}@]<img src="[@{$images_path}@]pixel_trans.gif" alt="" style="display: block; width: 100%; height: 3px;" />
        <script type="text/javascript">
        /* <![CDATA[ */
  ...
  [@{/if}@]
    ...
    [@{if $data.case == 'name'}@]<td class="main product-listing-data-last" style="padding: 0 6px 0 6px;"><a href="[@{$data.products_link}@]">[@{$data.products_name}@]</a></td>[@{/if}@]
    ...
    [@{if $data.case == 'price'}@]
    <td class="product-listing-data-last">
                [@{if $data.price_breaks}@]
                <div>
                  <div style="float: right;">
                    <div id="toggle_arrow_[@{$data.products_id}@]" class="price-label small-text" style="padding: 2px; text-align: right; white-space: nowrap;"><a><img onmouseover="this.style.cursor='pointer'" src="[@{$images_path}@]icon_arrow_down.gif" height="10" width="13" alt="" /></a>&nbsp;&nbsp;&nbsp;&nbsp;<b>[@{if $data.price_special}@]<span class="text-deco-line-through">[@{$data.price}@]</span> <span class="product-special-price">[@{$data.price_special}@]</span>[@{else}@][@{$data.price}@][@{/if}@]</b></div>
    ...
    [@{/if}@]                
    [@{if $data.case == 'quantity'}@]<td class="product-listing-data-last" style="text-align: center;">&nbsp;[@{$data.products_quantity}@]&nbsp;</td>[@{/if}@]
    [@{if $data.case == 'weight'}@]<td class="product-listing-data-last" style="text-align: right;">&nbsp;[@{$data.products_weight}@]kg&nbsp;</td>[@{/if}@]
    [@{if $data.case == 'image'}@]<td class="product-listing-data-last" style="text-align: center;">&nbsp;<a href="[@{$data.products_link_image}@]">[@{$data.products_image_small}@]</a>&nbsp;</td>[@{/if}@]
    [@{if $data.case == 'buy_now'}@]
      <td class="product-listing-data-last" style="white-space: nowrap; text-align: right;">
        [@{$data.products_buy_form_begin}@][@{$data.products_hidden_field}@][@{$data.products_input_quantity}@]<img src="[@{$images_path}@]pixel_trans.gif" alt="" style="display: block; width: 100%; height: 3px;" />
        <script type="text/javascript">
        /* <![CDATA[ */
          document.write('<a href="" onclick="[@{$data.form_name}@].submit(); return false" class="button-buy-now" style="float: right" title=" [@{#button_title_buy_now#}@] "><span>[@{#button_text_buy_now#}@]</span></a><input type="image" src="[@{$images_path}@]pixel_trans.gif" alt="" />')
