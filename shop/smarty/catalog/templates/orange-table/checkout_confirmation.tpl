    ...
    <td width="100%" valign="top">[@{$form_begin}@]<table border="0" width="100%" cellspacing="0" cellpadding="0">
        ...
        <td><table border="0" width="100%" cellspacing="1" cellpadding="2" class="info-box-central">
          <tr class="info-box-central-contents">
            <td width="50%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                <td nowrap="nowrap" class="main"><b>[@{#heading_billing_address#}@]</b> <a href="[@{$link_filename_checkout_payment_address}@]"><span class="order-edit">([@{#text_edit#}@])</span></a></td>
              </tr>
              <tr>
                <td nowrap="nowrap" class="main">[@{$billing_address}@]</td>
              </tr>
              <tr>
                <td nowrap="nowrap" class="main"><b>[@{#heading_payment_method#}@]</b> <a href="[@{$link_filename_checkout_payment}@]"><span class="order-edit">([@{#text_edit#}@])</span></a></td>
              </tr>
              <tr>
           ...
           [@{if $delivery_address}@]
            <td width="50%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                <td nowrap="nowrap" class="main"><b>[@{#heading_delivery_address#}@]</b> <a href="[@{$link_filename_checkout_shipping_address}@]"><span class="order-edit">([@{#text_edit#}@])</span></a></td>
              </tr>
              <tr>
             ...
             [@{if $shipping_method}@] 
              <tr>
                <td nowrap="nowrap" class="main"><b>[@{#heading_shipping_method#}@]</b> <a href="[@{$link_filename_checkout_shipping}@]"><span class="order-edit">([@{#text_edit#}@])</span></a></td>
              </tr>
              <tr>
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr>      
            <td class="main"><b>[@{#heading_products#}@]</b> <a href="[@{$link_filename_shopping_cart}@]"><span class="order-edit">([@{#text_edit#}@])</span></a></td>
          </tr>
        </table></td>        
      </tr>     
      <tr>
                  ...
                  <tr class="product-listing-checkout-confirmation-background">
                    ...
                    <td nowrap="nowrap" class="product-listing-checkout-confirmation-data" valign="top">
                      <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>            
                          <td colspan="3" class="product-listing-checkout-confirmation-data" nowrap="nowrap">
     ...
     [@{if $comments}@]
      ...
      <tr>      
        <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr>      
            <td class="main"><b>[@{#heading_order_comments#}@]</b> <a href="[@{$link_filename_checkout_payment}@]"><span class="order-edit">([@{#text_edit#}@])</span></a></td>
          </tr>
        </table></td>              
      </tr>
      <tr>
        ...
        <td><table border="0" width="100%" cellspacing="1" cellpadding="2" class="info-box-central">
          <tr class="info-box-central-contents">
            <td><table border="0" cellspacing="0" cellpadding="2">
              <tr>
                <td class="main" colspan="3">[@{$confirmation_title}@]</td>
              </tr>
        ...
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="25%"><table border="0" width="100%" cellspacing="0" cellpadding="0">
              <tr>
                <td width="50%"><img src="[@{$images_path}@]pixel_silver.gif" alt="" width="100%" height="1" /></td>
                <td><img src="[@{$images_path}@]arrow_checkout.gif" alt="" /></td>
                <td width="50%"><img src="[@{$images_path}@]pixel_silver.gif" alt="" width="100%" height="1" /></td>
              </tr>
            </table></td>
            <td width="25%"><table border="0" width="100%" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td align="center" width="25%" class="checkout-bar-from"><a href="[@{$link_filename_checkout_shipping}@]" class="checkout-bar-from">[@{#checkout_bar_delivery#}@]</a></td>
            <td align="center" width="25%" class="checkout-bar-from"><a href="[@{$link_filename_checkout_payment}@]" class="checkout-bar-from">[@{#checkout_bar_payment#}@]</a></td>
            <td align="center" width="25%" class="checkout-bar-current">[@{#checkout_bar_confirmation#}@]</td>
