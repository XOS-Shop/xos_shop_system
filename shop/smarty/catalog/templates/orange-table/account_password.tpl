      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr>
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                <td class="main"><b>[@{#my_password_title#}@]</b></td>
            ...
            <td><table border="0" width="100%" cellspacing="1" cellpadding="2" class="info-box-central">
              <tr class="info-box-central-contents">
                <td><table border="0" cellspacing="2" cellpadding="2">
                  <tr>
                    <td class="main">[@{#entry_password_current#}@]</td>
                    <td class="main">[@{$input_password_current}@]</td>
                  </tr>
                  <tr>
                    <td colspan="2"><img src="[@{$images_path}@]pixel_trans.gif" alt="" width="100%" height="10" /></td>
                  </tr>
                  <tr>
                    <td class="main">[@{#entry_password_new#}@]</td>
                    <td class="main">[@{$input_password_new}@]</td>
                  </tr>
                  <tr>
                    <td class="main">[@{#entry_password_confirmation#}@]</td>
                    <td class="main">[@{$input_password_confirmation}@]</td>
                  </tr>
                </table></td>
              </tr>
            </table></td>
            ...
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                ...
                <td nowrap="nowrap" align="right">
                  ...
                  /* <![CDATA[ */
                    document.write('<a href="" onclick="if(account_password.onsubmit())account_password.submit(); return false" class="button-continue" style="float: right" title=" [@{#button_title_continue#}@] "><span>[@{#button_text_continue#}@]</span></a><input type="image" src="[@{$images_path}@]pixel_trans.gif" alt="" />')
                  /* ]]> */  
                  </script>
                  <noscript>
