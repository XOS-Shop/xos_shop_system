    ...
    <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
        ...
        [@{if $page_info == 'false' or $heading_title}@]
          <tr>
            <td class="page-heading">[@{$heading_title|default:$category_name}@]</td>
            <td class="page-heading" align="right">[@{$heading_image}@]</td>
            <td class="page-heading" align="right" width="1"><img src="[@{$images_path}@]pixel_trans.gif" alt="" width="[@{#page_heading_width#}@]" height="[@{#page_heading_height#}@]" /></td>
          </tr>
          [@{if $category_description}@]
          <tr>
            <td colspan="3" class="main">[@{$category_description}@]</td>
          </tr>
          [@{/if}@]                       
        [@{else}@]
          <tr>
          ...
          <tr>
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              ...
              [@{foreach item=categorie from=$categories}@]
                <td align="center" class="small-text" width="[@{$categorie.td_width}@]" valign="top"><a href="[@{$categorie.link_to_product_listing}@]">[@{$categorie.image}@]<br />[@{$categorie.name}@]</a></td>
    ...
    <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
        ...
        [@{if $page_info == 'false' or $heading_title or $manufacturer}@] 
          <tr>
            [@{if $manufacturer}@]
            <td class="page-heading">[@{#heading_title_manufacturer#}@] [@{$heading_title}@]</td>
            [@{else}@]
            <td class="page-heading">[@{$heading_title|default:$category_name}@]</td>
            [@{/if}@]
            <td class="page-heading" align="right">[@{$heading_image}@]</td>
