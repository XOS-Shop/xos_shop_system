            ...
            <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="0">
              <tr>
                <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
                  <tr>
                    <td class="main"><b>[@{eval var=#text_review_by#}@]</b></td>
                  ...
                  <tr class="info-box-central-contents">
                    <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
                      <tr>
                        ...
                        <td valign="top" class="main">[@{$review_text}@]<br /><br /><i>[@{#text_review_rating#}@] [@{$stars_image}@] [[@{eval var=#text_of_5_stars#}@]]</i></td>
                  ...
                  <tr class="info-box-central-contents">
                    <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
                      <tr>
                        ...
                        <td nowrap="nowrap" class="main"><a href="[@{$link_filename_product_reviews_write}@]" class="button-write-review" style="float: right" title=" [@{#button_title_write_review#}@] "><span>[@{#button_text_write_review#}@]</span></a></td>                                             
                        <td width="10"><img src="[@{$images_path}@]pixel_trans.gif" alt="" width="10" height="1" /></td>
                      </tr>
                    </table></td>
                  </tr>
