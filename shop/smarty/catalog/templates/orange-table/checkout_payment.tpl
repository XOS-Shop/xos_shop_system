...
<!-- checkout_payment -->
    <td width="100%" valign="top">[@{$form_begin}@]<table border="0" width="100%" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="1" cellpadding="2" class="info-box-notice">
          <tr class="info-box-notice-contents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
     ...
     [@{/if}@]      
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td align="center" width="25%" class="checkout-bar-from"><a href="[@{$link_filename_checkout_shipping}@]">[@{#checkout_bar_delivery#}@]</a></td>
