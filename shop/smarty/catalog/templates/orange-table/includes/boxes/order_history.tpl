        ...
        <td>
          <table border="0" width="100%" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="100%" class="info-box-heading">[@{#box_heading_customer_orders#}@]</td>
              ...
              <td><table border="0" width="100%" cellspacing="0" cellpadding="3" class="info-box-contents">
                ...
                <tr>
                  ...
                  [@{foreach item=customer_order from=$box_order_history_customer_orders}@]
                    <tr>
                      <td class="info-box-contents"><a href="[@{$customer_order.link_filename_product_info}@]">[@{$customer_order.name}@]</a></td>
                      <td class="info-box-contents" align="right" valign="top"><a href="[@{$customer_order.in_cart}@]"><img src="[@{$images_path}@]cart.gif" alt="[@{#in_cart#}@]" title=" [@{#in_cart#}@] " /></a></td>
                    </tr>
                  [@{/foreach}@]  
                  </table></td>
                </tr>
