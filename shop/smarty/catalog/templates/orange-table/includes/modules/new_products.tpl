  ...
  <tr>
    ...
    [@{/if}@]  
        <td align="center" class="small-text" width="33%" valign="top">
          <div style="border: solid 1px #b6b7cb">
            <br />
            <a href="[@{$new_product.link_filename_product_info}@]"><span class="main" style="font-weight: bold">[@{$new_product.name}@]</span><br /><br />[@{$new_product.image}@]</a><br />
            [@{if $new_product.price_special}@]
              <span class="text-deco-line-through">[@{$new_product.price}@]</span> <span class="product-special-price">[@{$new_product.price_special}@]</span><br />
            [@{else}@]
