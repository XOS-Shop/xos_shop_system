...
<!-- account --> 
      ...
      [@{/if}@]        
          ...
          <div class="panel panel-default clearfix">           
            ...
            <div class="row">                      
              <div class="col-sm-2 text-center hidden-xs">
                <span class="text-info glyphicon glyphicon-folder-open" style="font-size: 30px; line-height: 70px;"></span>            
              </div>
              <div class="col-sm-10">
          ...
          <div class="panel panel-default clearfix">           
            ...
            <div class="row">                     
              <div class="col-sm-2 text-center hidden-xs">
                <span class="text-info glyphicon glyphicon-list-alt" style="font-size: 32px; line-height: 55px;"></span>            
              </div>
              <div class="col-sm-10">
      ...
      [@{if $link_filename_account_newsletters || $link_filename_account_notifications}@]      
          ...
          <div class="panel panel-default clearfix">           
            ...
            <div class="row">                      
              <div class="col-sm-2 text-center hidden-xs">
                <span class="text-info glyphicon glyphicon-envelope" style="font-size: 32px; line-height: 55px;"></span>            
              </div>
              <div class="col-sm-10">
