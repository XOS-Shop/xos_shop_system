    ...
    photo:true
              ...
              <div class="col-sm-7 col-md-7">
                ...
                <div style="width:100%; position:relative; left:0px; top: -10px; z-index:3;">                                
                  <div id="loading_list" style="background:#485563; display:none; position:absolute; right:0px; top:0px; padding-left:20px; padding-top:10px; padding-right:20px; padding-bottom:40px; min-width:300px;">                                                             
                    <div style="width:100%; margin:0 auto; text-align:center;">             
                      [@{#text_loading#}@]
                    </div>                                                                          
                  </div>                                                 
                  <div id="box_products_options_overview" style="background:#485563; display:none; position:absolute; right:0px; top:0px; padding-left:20px; padding-top:10px; padding-right:20px; padding-bottom:40px; min-width:300px;">                                                                                          
                  </div>                
                </div>');
                [@{/strip}@]
