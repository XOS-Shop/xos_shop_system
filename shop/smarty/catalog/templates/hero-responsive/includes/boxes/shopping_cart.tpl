              ...
              <ul id="shopping_cart_list" class="dropdown-menu" role="menu">
                <li>        
                  [@{if $products_quantity_total == 0}@]
                    <div style="width:120px; padding: 11px 3px 11px 3px; float: right; background-color: #4e5d6c;">[@{#box_shopping_cart_empty#}@]</div>
                  [@{else}@]
                    <div id="shopping_cart_box_content" style="width: 200px; padding: 11px 3px 3px 3px; text-align: left; float: right; background-color: #4e5d6c;">
