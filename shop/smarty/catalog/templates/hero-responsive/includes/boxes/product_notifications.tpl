...
<!-- product_notifications -->
          <div class="panel panel-default">
            ...
            [@{if $box_product_notifications_notification_exists}@]
              <div><a href="[@{$box_product_notifications_link_notify_notify_remove}@]"><span class="text-info glyphicon glyphicon-list-alt" style="font-size: 40px; line-height: 55px;"></span></a></div>
