...
<!-- specials -->
          <div class="panel panel-default">
            <div class="panel-heading"><h3 class="panel-title"><a href="[@{$box_specials_link_filename_specials}@]">[@{#box_heading_specials#}@]&nbsp;<span style="vertical-align: text-top;">»</span></a></h3></div>
