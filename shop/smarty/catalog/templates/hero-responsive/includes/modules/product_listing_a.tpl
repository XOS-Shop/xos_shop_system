                        ...
                        <td>                                    
                          ...
                          <div class="price-label small-text">  
                            ...
                            <table class="table-border-cellspacing cellpadding-0px">                
                              ...
                              <tr>                       
                                <td colspan="2" class="text-center text-nowrap"><img src="[@{$images_path}@]pixel_trans.gif" alt="" style="display: block; width: 100%; height: 4px;" />[@{#text_price_breaks#}@]<img src="[@{$images_path}@]pixel_white.gif" alt="" style="display: block; width: 100%; height: 1px;" /></td>
                              </tr>                      
                              <tr>
