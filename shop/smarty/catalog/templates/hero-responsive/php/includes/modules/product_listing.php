...
//    }
  ...
  if ($listing_split->number_of_rows > 0) {      
        ...
        switch ($column_list[$col]) {
          ...
          case 'PRODUCT_LIST_BUY_NOW':
            $table_inner_array[]=array('case' => 'buy_now',
                                       ...
                                       'products_input_quantity' => xos_draw_input_field('products_quantity', '1','id="products_quantity_' . $listing['products_id'] . '" style="width: 30px; padding-left: 2px; padding-right: 0px;" class="form-control" maxlength="5"'),
    ...
    $smarty->assign(array('listing' => true,
                          ...
                          'nav_bar_result' => '<nav><ul class="pagination">' . $listing_split->display_links(MAX_DISPLAY_PAGE_LINKS, xos_get_all_get_params(array('page', 'info', 'language', 'currency', 'tpl', 'x', 'y'))) . '</ul></nav>',
