          ...
          <fieldset>          
            <div class="panel panel-default clearfix">           
              <div class="panel-body form-horizontal">            
                ...
                [@{if $default_address}@]
                <div class="form-group">
                  <label class="col-sm-4 control-label" for="company_tax_id">[@{#entry_company_tax_id#}@]</label><span class="input-requirement-moved">[@{$smarty.const.ENTRY_COMPANY_TAX_ID_TEXT}@]</span>
                  <div class="col-sm-6 col-md-5 col-lg-4">
                    [@{$company_tax_id|replace:'>&nbsp;':'>'}@]
                  </div>  
                </div>               
                [@{/if}@]
                [@{/if}@]
