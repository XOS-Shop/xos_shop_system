...
<!-- tabs -->
  <div class="tab-nav">
    ...
    [@{foreach name=outer item=tab_cat from=$boxes_categories_tabs_full_tabs}@]
      ...
      <li class="tab-[@{$tab_cat.class_name}@]" style="position: relative; z-index: [@{1700 - $smarty.foreach.outer.iteration}@];"><a href="[@{$tab_cat.href_link}@]">[@{$tab_cat.name}@][@{if $tab_cat.count_products}@]&nbsp;([@{$tab_cat.count_products}@])[@{/if}@]</a><span class="tab-sub-cat-touchpad"><b></b></span><div class="clearfix invisible"></div><ul class="ul-tab-inner">
