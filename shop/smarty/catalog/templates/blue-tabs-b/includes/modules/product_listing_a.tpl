  ...
  [@{/if}@]
    ...
    [@{if $data.case == 'buy_now'}@]
      <td nowrap="nowrap" align="right" class="product-listing-data">
        ...
        <script type="text/javascript">
        /* <![CDATA[ */
          document.write('<a href="" onclick="[@{$data.form_name}@].submit(); return false" class="button-buy-now" style="float: right; margin-top: 3px;" title=" [@{#button_title_buy_now#}@] "><span>[@{#button_text_buy_now#}@]</span></a><input type="image" src="[@{$images_path}@]pixel_trans.gif" alt="" />')
        /* ]]> */  
        </script>
        <noscript>
          <input type="submit" value="[@{#button_text_buy_now#}@]" style="margin-top: 3px;" />
        </noscript>                                   
        [@{$data.form_end}@]
      </td>
    [@{/if}@]                                                                                    
