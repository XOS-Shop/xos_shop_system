...
<div style="position:relative; left:0px; top:0px; z-index:1001">
  <div style="width:170px; position:absolute; left:222px; top:10px;"> 
    [@{$box_currencies}@]
  </div> 
  <div style="width:170px; position:absolute; [@{if $is_shop}@]left:422px[@{else}@]right:4px[@{/if}@]; top:13px;"> 
    [@{$box_languages}@]
  </div>
  <div style="width:170px; position:absolute; left:5px; top:10px;"> 
    [@{$box_search}@]
  </div>
