  ...
  $(function(){
    ...
    [@{$form_begin}@] 
          ...
          <div class="row">                                                                          
            ...
            <div class="col-sm-1 hidden-xs" style="white-space: nowrap;"><div class="text-nowrap">&nbsp;</div><button class="btn btn-link btn-xs" title=" [@{#text_update_product#}@] "><span class="glyphicon glyphicon-refresh" style="font-size:22px; font-weight:bold; color:blue;"></span></button></div>
            <div class="col-sm-1 hidden-xs" style="white-space: nowrap;"><div class="text-nowrap">&nbsp;</div><a href="[@{$product.link_remove_product}@]"><span class="glyphicon glyphicon-trash" style="font-size:22px; color:red;" title=" [@{#text_remove_product#}@] "></span></a></div>
          ...
          <div class="row visible-xs-block"> 
            ...
            <div class="col-xs-4 text-nowrap text-center"><button class="btn btn-link btn-xs" title=" [@{#text_update_product#}@] "><span class="glyphicon glyphicon-refresh" style="font-size:22px; font-weight:bold; color:blue;"></span></button>&nbsp;&nbsp;</div>
            <div class="col-xs-4 text-nowrap text-right"><a href="[@{$product.link_remove_product}@]"><span class="glyphicon glyphicon-trash" style="font-size:22px; color:red;" title=" [@{#text_remove_product#}@] "></span></a></div>
          </div>          
          <hr>
          [@{/foreach}@]                  
          <div class="div-spacer-h10"></div>
