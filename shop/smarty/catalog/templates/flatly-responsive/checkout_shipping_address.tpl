...
<!-- checkout_shipping_address -->
    [@{$form_begin}@]
     ...
     [@{if !$process}@]                                                                      
          ...
          <div class="panel panel-default clearfix">           
            <div class="panel-body">                      
              <div class="row">              
                <div class="col-md-6">[@{#text_selected_shipping_destination#}@]</div>
                <div class="col-md-6">
                  <div class="row">
       ...
       [@{if $several_addresses}@]          
          ...
          <div class="panel panel-default clearfix">           
            <div class="panel-body">             
              <div class="clearfix">
                <div class="pull-left">[@{#text_select_other_shipping_destination#}@]<br /><br /></div>
     ...
     [@{if $not_max_address_book_entries}@]
          <div class="pull-left"><b>[@{#table_heading_new_shipping_address#}@]</b></div>
          <div class="input-requirement-moved pull-right">[@{#form_required_information#}@]</div>
          <div class="clearfix invisible"></div>          
          <div class="panel panel-default clearfix">           
            <div class="panel-body">                      
              <div>[@{#text_create_new_shipping_address#}@]</div>
     ...
     [@{if $process}@]
          <div class="well well-sm clearfix"> 
            <div><a href="[@{$link_filename_checkout_shipping_address}@]" class="btn btn-primary pull-left" title=" [@{#button_title_back#}@] ">[@{#button_text_back#}@]</a></div>                                                                                                                                                                  
          </div>             
     [@{/if}@]
    [@{$form_end}@]
