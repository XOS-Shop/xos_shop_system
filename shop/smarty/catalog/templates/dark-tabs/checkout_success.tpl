...
<!-- checkout_success -->
    [@{$form_begin}@]
          ...
          <div style="padding-left: 200px;">
            ...
            [@{foreach name=outer item=product_notify from=$products_notify}@]
            [@{$product_notify.checkbox_field}@] <label for="checkbox_product_[@{$smarty.foreach.outer.iteration}@]">[@{$product_notify.text}@]</label><br />
            [@{/foreach}@]
            </span><br /><br />
            [@{/if}@]
