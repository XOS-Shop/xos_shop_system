...
<!-- checkout_shipping -->
    [@{$form_begin}@][@{$hidden_field}@]
          ...
          <h3 class="main"><b>[@{#table_heading_shipping_address#}@]</b></h3>
          ...
          <div style="height: 10px; font-size: 0;">&nbsp;</div>           
     [@{if $shipping_modules}@]
          <h3 class="main"><b>[@{#table_heading_shipping_method#}@]</b></h3>       
          <div class="info-box-central-contents">          
            ...
            <div style="width: 95%; padding: 2px 2px 2px 16px;"> 
              ...
              [@{/if}@]                   
                <div class="main" style="width: 74%; padding: 2px; float: left;"><label for="shipping_[@{$method.radio_select}@]">[@{$method.title}@]</label></div>
          ...
          <div style="height: 10px; font-size: 0;">&nbsp;</div>               
     [@{/if}@]
          <h3 class="main"><label for="checkout_shipping_comments"><b>[@{#table_heading_comments#}@]</b></label></h3>       
          <div class="info-box-central-contents">                             
