...
<!-- product_reviews -->
          <h1 class="page-heading" style="line-height: [@{#page_heading_height#}@]px;">[@{$products_name}@]</h1>           
        ...
        [@{if $product_reviews}@]
          <div style="width: 450px; padding: 0 4px 0 0; float: left;">          
            ...
            <h3 class="main" style="float: left; padding: 2px;"><a href="[@{$product_reviews.link_filename_product_reviews_info}@]"><span class="text-deco-underline"><b>[@{eval var=#text_review_by#}@]</b></span></a></h3>          
