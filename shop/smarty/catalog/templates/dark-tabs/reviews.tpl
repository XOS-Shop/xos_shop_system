...
<!-- reviews -->
        ...
        [@{if $reviews}@]       
          ...
          <h3 class="main" style="float: left; padding: 2px;"><a href="[@{$review.link_filename_product_reviews_info}@]"><span class="text-deco-underline"><b>[@{$review.products_name}@]</b></span></a><span class="small-text"> [@{eval var=#text_review_by#}@]</span></h3>          
