...
<!-- account --> 
          ...
          [@{/if}@]           
      [@{if $customer_orders}@]      
          <h3 class="main"><b>[@{#overview_title#}@]</b>&nbsp;<a href="[@{$link_filename_account_history}@]"><span class="text-deco-underline">[@{#overview_show_all_orders#}@]</span></a></h3>      
          ...
          <div style="height: 10px; font-size: 0;">&nbsp;</div>      
      [@{/if}@]      
          <h3 class="main"><b>[@{#my_account_title#}@]</b></h3>
          <div class="info-box-central-contents">
          ...
          <div style="height: 10px; font-size: 0;">&nbsp;</div>                                          
          <h3 class="main"><b>[@{#my_orders_title#}@]</b></h3>
          <div class="info-box-central-contents"> 
      ...
      [@{if $link_filename_account_newsletters || $link_filename_account_notifications}@]      
          <h3 class="main"><b>[@{#email_notifications_title#}@]</b></h3>      
          <div class="info-box-central-contents">
