    ...
    [@{$form_begin}@]        
      ...
      [@{else}@]      
        ...
        [@{/if}@] 
            ...
            <div class="main" style="padding: 4px; width: 600px;">[@{$textarea}@]</div> 
          ...
          <div class="info-box-central-contents">                             
            <div class="main" style="margin: 4px 15px 4px 15px;">
              <div style="float: right;">                      
                ...
                /* <![CDATA[ */
                  document.write('<a href="" onclick="contact_us.submit(); return false" class="button-continue" style="float: left" title=" [@{$smarty.const.CONTACT_US_BUTTON_TITLE_CONTINUE}@] "><span>[@{$smarty.const.CONTACT_US_BUTTON_TEXT_CONTINUE}@]</span></a><input type="image" src="[@{$images_path}@]pixel_trans.gif" alt="" />')
                /* ]]> */  
                </script>
                <noscript>
