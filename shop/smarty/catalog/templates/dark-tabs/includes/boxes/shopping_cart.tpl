              ...
              <div class="rb">
                <div class="lb">
                  <div class="box-content">
                    <h3 id="shopping_cart_box_header" class="info-box-heading"><a href="[@{$box_shopping_cart_link_filename_shopping_cart}@]"><img src="[@{$images_path}@]arrow_right.gif" alt="[@{#more#}@]" title=" [@{#more#}@] " />[@{#box_heading_shopping_cart#}@]</a></h3>
