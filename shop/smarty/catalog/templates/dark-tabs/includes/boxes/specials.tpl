              ...
              <div class="rb">
                <div class="lb">
                  <div class="box-content">
                    <h2 class="info-box-heading"><a href="[@{$box_specials_link_filename_specials}@]"><img src="[@{$images_path}@]arrow_right.gif" alt="[@{#more#}@]" title=" [@{#more#}@] " />[@{#box_heading_specials#}@]</a></h2>
