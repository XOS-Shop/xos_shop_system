...
/* ]]> */  
          ...
          <div >                  
            ...
            <div class="small-text" style="padding: 4px; float: left; width: 32%">   
              <div class="r-orange"> 
                      ...
                      <div class="rb-orange">
                        <div class="lb-orange">
                          <div class="box-content-orange">                              
                            <div style="overflow: hidden; padding: 2px; background : inherit;">
                              ...
                              [@{if $data.case == 'name'}@]<h3 class="main" style="padding: 2px; text-align: center;"><b><a href="[@{$data.products_link}@]"><span class="text-deco-underline">[@{$data.products_name}@]</span></a></b></h3>[@{/if}@]
                              ...
                              <div style="width: 100%;">
                                <div style="padding: 6px 0 2px 2px;">
                                  ...
                                  <div style="margin-top: 2px; padding: 0 4px 0 0; float: right;">
                                    <span class="hidden"><label for="[@{$data.label_for_products_input_quantity}@]">[@{#text_quantity_in_hidden_field#}@]</label></span>
