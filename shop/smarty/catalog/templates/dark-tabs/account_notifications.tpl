...
<!-- account_notifications -->
    [@{$form_begin}@][@{$hidden_field}@]
          ...
          <h3 class="main"><b>[@{#my_notifications_title#}@]</b></h3>    
          ...
          <div style="height: 10px; font-size: 0;">&nbsp;</div>
          <h3 class="main"><b>[@{#global_notifications_title#}@]</b></h3>  
          <div class="info-box-central-contents" style="padding: 2px 12px 2px 12px;">
            <div class="module-row" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)" onclick="checkBox('product_global')">
              <div class="main" style="padding: 4px;">[@{$checkbox_field_product_global}@]&nbsp;<b>[@{#global_notifications_title#}@]</b><span class="hidden"><label for="checkbox_products_global">[@{#global_notifications_title#}@]</label></span></div>
            </div>
            <div class="main" style="padding: 2px 28px 4px 28px;">[@{#global_notifications_description#}@]</div>
          </div>                
          <div style="height: 10px; font-size: 0;">&nbsp;</div>    
          [@{if $not_global_product_notifications}@]      
          <h3 class="main"><b>[@{#notifications_title#}@]</b></h3>  
          <div class="info-box-central-contents" style="padding: 2px 12px 2px 12px;">            
            [@{if $products_notification}@] 
            <div class="main" style="padding: 4px 20px 4px 4px;">[@{#notifications_description#}@]</div>
            [@{foreach name=outer item=product_notification from=$products_notifications_array}@] 
            <div class="module-row" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)" onclick="checkBox('products[[@{$product_notification.product_counter}@]]')">
              <div class="main" style="padding: 0 4px 0 4px;">[@{$product_notification.checkbox_field_product}@]&nbsp;<b>[@{$product_notification.product_name}@]</b><span class="hidden"><label for="checkbox_product_[@{$smarty.foreach.outer.iteration}@]">[@{$product_notification.product_name}@]</label></span></div>
            </div>                 
           [@{/foreach}@]
