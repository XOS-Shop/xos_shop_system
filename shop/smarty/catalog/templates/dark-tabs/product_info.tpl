...
/* ]]> */
              ...
              <div style="padding: 2px 0 0 0; float: left;">
...
/* ]]> */   
              ...
              <div style="width : 442px; float: right;">
                <h1 class="page-heading" style="line-height: 21px; padding: 0 0 4px 0;">[@{$products_name}@]</h1>               
                ...
                <div class="info-box-central-contents">                             
                  <div class="main" style="margin: 4px 15px 4px 15px;">                      
                    ...
                    <div style="margin: -1px; padding: 0 4px 0 0; float: right;">
                      <span class="hidden"><label for="products_quantity">[@{#text_quantity_in_hidden_field#}@]</label></span>
                      [@{$hidden_field_products_id}@][@{$input_products_quantity}@]
                    </div>
                    [@{if $link_filename_product_reviews}@]                             
                    <div style="margin: 0; padding: 0 60px 0 0; float: right;">
