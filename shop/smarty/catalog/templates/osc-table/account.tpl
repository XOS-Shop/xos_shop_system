          ...
          <tr class="infoBoxContents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                ...
                <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
                  <tr>
                    <td class="main"><img src="[@{$images_path}@]arrow_green.gif" alt="" /> <a href="[@{$link_filename_account_edit}@]">[@{#my_account_information#}@]</a></td>
                  </tr>
                  <tr>
                    <td class="main"><img src="[@{$images_path}@]arrow_green.gif" alt="" /> <a href="[@{$link_filename_address_book}@]">[@{#my_account_address_book#}@]</a></td>
                  </tr>
                  <tr>
                    <td class="main"><img src="[@{$images_path}@]arrow_green.gif" alt="" /> <a href="[@{$link_filename_account_password}@]">[@{#my_account_password#}@]</a></td>
                  </tr>
                </table></td>
          ...
          <tr class="infoBoxContents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                ...
                <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
                  <tr>
                    <td class="main"><img src="[@{$images_path}@]arrow_green.gif" alt="" /> <a href="[@{$link_filename_account_history}@]">[@{#my_orders_view#}@]</a></td>
                  </tr>
                </table></td>
                <td width="10" align="right"><img src="[@{$images_path}@]pixel_trans.gif" alt="" width="10" height="1" /></td>
              </tr>
            ...
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                ...
                <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
                  ...
                  <tr>
                    <td class="main"><img src="[@{$images_path}@]arrow_green.gif" alt="" /> <a href="[@{$link_filename_account_newsletters}@]">[@{#email_notifications_newsletters#}@]</a></td>
                  </tr>
                  [@{/if}@]
                  [@{if $link_filename_account_notifications}@]                  
                  <tr>
                    <td class="main"><img src="[@{$images_path}@]arrow_green.gif" alt="" /> <a href="[@{$link_filename_account_notifications}@]">[@{#email_notifications_products#}@]</a></td>
                  </tr>
                  [@{/if}@]                  
                </table></td>
                <td width="10" align="right"><img src="[@{$images_path}@]pixel_trans.gif" alt="" width="10" height="1" /></td>
