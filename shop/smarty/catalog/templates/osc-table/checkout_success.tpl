    ...
    <td width="100%" valign="top">[@{$form_begin}@]<table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
        <td><table border="0" width="100%" cellspacing="4" cellpadding="2">
          <tr>
            <td valign="top"><img src="[@{$images_path}@]table_background_man_on_board.gif" alt="[@{#heading_title#}@]" title=" [@{#heading_title#}@] " /></td>
            <td valign="top" class="main"><img src="[@{$images_path}@]pixel_trans.gif" alt="" width="1" height="10" />
              <div align="center" class="pageHeading">[@{#heading_title#}@]</div><br />
            [@{#text_success#}@]<br /><br />
            [@{if $notify}@]            
            [@{#text_notify_products#}@]<br /><span class="productsNotifications">
        ...
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="25%"><table border="0" width="100%" cellspacing="0" cellpadding="0">
              <tr>
                <td width="50%"><img src="[@{$images_path}@]pixel_silver.gif" alt="" width="100%" height="1" /></td>
                <td width="50%"><img src="[@{$images_path}@]checkout_bullet.gif" alt="" /></td>
              </tr>
            </table></td>
          </tr>
          <tr>
            <td align="center" width="25%" class="checkoutBarFrom">[@{#checkout_bar_delivery#}@]</td>
            <td align="center" width="25%" class="checkoutBarFrom">[@{#checkout_bar_payment#}@]</td>
            <td align="center" width="25%" class="checkoutBarFrom">[@{#checkout_bar_confirmation#}@]</td>
            <td align="center" width="25%" class="checkoutBarCurrent">[@{#checkout_bar_finished#}@]</td>
          </tr>
        </table></td>
      </tr>
      [@{$downloads}@]
