...
<!-- contact_us -->
    <td width="100%" valign="top">[@{$form_begin}@]<table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td class="pageHeading" align="right"><img src="[@{$images_path}@]table_background_contact_us.gif" alt="[@{#heading_title#}@]" title=" [@{#heading_title#}@] " /></td>
          </tr>
        </table></td>
      </tr>
      <tr>
      ...
      [@{if $sent}@]      
      <tr>
        <td class="main" align="center"><img src="[@{$images_path}@]table_background_man_on_board.gif" alt="[@{#heading_title#}@]" title=" [@{#heading_title#}@] " align="left" />[@{#text_success#}@]</td>
      </tr>
      <tr>
        <td><img src="[@{$images_path}@]pixel_trans.gif" alt="" width="100%" height="10" /></td>
      </tr>
