...
<!-- address_book -->
    <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td class="pageHeading" align="right"><img src="[@{$images_path}@]table_background_address_book.gif" alt="[@{#heading_title#}@]" title=" [@{#heading_title#}@] " /></td>
          </tr>
        </table></td>
      </tr>
      <tr>
      ...
      <tr>
        <td class="smallText"><font color="#ff0000"><b>[@{#text_maximum_entries_1#}@]</b></font> [@{eval var=#text_maximum_entries_2#}@]</td>
      </tr>
    </table></td>
<!-- address_book_eof -->
