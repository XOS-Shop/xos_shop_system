...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td height="14" class="infoBoxHeading" width="100%">[@{#text_also_purchased_products#}@]</td>
    ...
    [@{/if}@]  
        <td align="center" class="smallText" width="33%" valign="top">
          ...
          [@{if $also_purchased.price_special}@]
            <span class="text-deco-line-through">[@{$also_purchased.price}@]</span> <span class="productSpecialPrice">[@{$also_purchased.price_special}@]</span><br />
          [@{else}@]
