  ...
  [@{/if}@]
    ...
    <td align="right" class="productListing-data">
      ...
      [@{if $data.link_filename_popup_content_products_delivery_time && $data.products_delivery_time}@]
        <div class="smallText" style="padding: 2px; text-align: right; white-space: nowrap;"><b>[@{#text_delivery_time#}@]</b>&nbsp;<a href="[@{$data.link_filename_popup_content_products_delivery_time}@]" class="lightbox-system-popup" target="_blank"><span class="text-deco-underline">[@{$data.products_delivery_time}@]</span></a></div>
      [@{elseif $data.products_delivery_time}@]
        <div class="smallText" style="padding: 2px; text-align: right; white-space: nowrap;"><b>[@{#text_delivery_time#}@]</b>&nbsp;[@{$data.products_delivery_time}@]</div>        
      [@{/if}@]       
      <script type="text/javascript">
      /* <![CDATA[ */
