        ...
        <td>
          <table border="0" width="100%" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="100%" height="14" class="infoBoxHeading">[@{#box_heading_login_my_account_my_account#}@]</td>
      ...
      <tr>
        <td>
          <table border="0" width="100%" cellspacing="0" cellpadding="0">
            <tr>
              <td height="14" class="infoBoxHeading"><img src="[@{$images_path}@]corner_right_left.gif" alt="" /></td>
              <td width="100%" height="14" class="infoBoxHeading">[@{#box_heading_login_my_account_login_here#}@]</td>
              <td height="14" class="infoBoxHeading" nowrap="nowrap"><img src="[@{$images_path}@]pixel_trans.gif" alt="" width="11" height="14" /></td>
            </tr>
          </table>
          <table border="0" width="100%" cellspacing="0" cellpadding="1" class="infoBox">
            <tr>
              <td><table border="0" width="100%" cellspacing="0" cellpadding="3" class="infoBoxContents">
                ...
                <tr>
                  <td class="boxText">[@{$box_login_my_account_form_begin}@]<table border="0" width="100%" cellspacing="0" cellpadding="0">
                    <tr>
                      <td class="infoBoxContents">
              	        [@{$box_login_my_account_welcome_string}@]<br /><br />
                      </td>
