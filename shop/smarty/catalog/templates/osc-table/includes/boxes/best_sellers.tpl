        ...
        <td>
          <table border="0" width="100%" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="100%" height="14" class="infoBoxHeading">[@{#box_heading_bestsellers#}@]</td>
              ...
              <td><table border="0" width="100%" cellspacing="0" cellpadding="3" class="infoBoxContents">
                ...
                <tr>
                  ...
                  [@{foreach item=bestseller from=$box_best_sellers_bestsellers}@]
                    <tr>
                      <td class="infoBoxContents" valign="top">[@{$bestseller.number}@].</td>
                      <td class="infoBoxContents"><a href="[@{$bestseller.link_filename_product_info}@]">[@{$bestseller.name}@]</a></td>
                    </tr>
                  [@{/foreach}@]  
                  </table></td>
                </tr>
