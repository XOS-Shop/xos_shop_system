...
<body>
    ...
    <tr>
     <td>
      <table border="0" align="center" cellpadding="0" cellspacing="0">
       <tr>
        <td width="1"><img src="[@{$images_path}@]pixel_trans.gif" alt="" width="1" height="[@{$blind_image_height}@]" /></td>
        <td align="center">[@{$popup_image}@]</td>
       </tr>
      </table>
     </td>
    </tr>  
  ...
  <table align="center" border="0" cellspacing="0" cellpadding="0">
   <tr>
     <td>
       <div style="padding: 6px 0 0 0;">[@{$small_images}@]</div>
     </td>
   </tr>
  </table>
  [@{/if}@]
