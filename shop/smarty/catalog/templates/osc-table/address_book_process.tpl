    ...
    <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td class="pageHeading">[@{#heading_title_delete_entry#}@]</td>
            <td class="pageHeading" align="right"><img src="[@{$images_path}@]table_background_address_book.gif" alt="[@{#heading_title_delete_entry#}@]" title=" [@{#heading_title_delete_entry#}@] " /></td>
          </tr>
        </table></td>
      </tr>
      <tr>
...
[@{elseif $edit_address}@]
    <td width="100%" valign="top">[@{$form_begin}@]<table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td class="pageHeading">[@{#heading_title_modify_entry#}@]</td>
            <td class="pageHeading" align="right"><img src="[@{$images_path}@]table_background_address_book.gif" alt="[@{#heading_title_modify_entry#}@]" title=" [@{#heading_title_modify_entry#}@] " /></td>
          </tr>
        </table></td>
      </tr>
      <tr>
...
[@{else}@]
    <td width="100%" valign="top">[@{$form_begin}@]<table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td class="pageHeading">[@{#heading_title_add_entry#}@]</td>
            <td class="pageHeading" align="right"><img src="[@{$images_path}@]table_background_address_book.gif" alt="[@{#heading_title_add_entry#}@]" title=" [@{#heading_title_add_entry#}@] " /></td>
          </tr>
        </table></td>
      </tr>
      <tr>
