...
<meta name="generator" content="XOS-Shop version 1.0 rc8, open source e-commerce system" />
<title></title>
</head>
<body>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="2">
      ...
      <tr>
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td nowrap="nowrap" style="font-family: Verdana, Arial, sans-serif; font-size: 11px;">[@{$email_greet}@] [@{#html_email_welcome#}@] [@{$store_name}@]<br /><br /></td>
          </tr>
          <tr>
            <td nowrap="nowrap" style="font-family: Verdana, Arial, sans-serif; font-size: 11px;">[@{#html_email_text#}@]</td>
          </tr>
          <tr>
            <td style="font-family: Verdana, Arial, sans-serif; font-size: 11px;">[@{#html_email_contact#}@] <a href="mailto:[@{$store_owner_email_address}@]">[@{$store_owner_email_address}@]</a><br /><br /></td>
          </tr> 
          <tr>
            <td style="font-family: Verdana, Arial, sans-serif; font-size: 11px;">[@{#html_email_warning#}@] <a href="mailto:[@{$store_owner_email_address}@]">[@{$store_owner_email_address}@]</a></td>
          </tr>                    
        </table></td>
      </tr>
    </table></td>
