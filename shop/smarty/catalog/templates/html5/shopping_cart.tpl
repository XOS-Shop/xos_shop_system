          ...
          <table class="table-border-cellspacing cellpadding-2px product-listing-cart" style="width: 100%">
            <tr>
             [@{if $tax_groups}@]                  
              ...
              <td class="product-listing-cart-heading" style="width: 5%; white-space: nowrap; text-align: center;">&nbsp; [@{#table_heading_quantity#}@]</td>              
              <td class="product-listing-cart-heading" style="width: 12%; white-space: nowrap; text-align: center;">&nbsp;</td>             
             ...
             [@{else}@]
              ...
              <td class="product-listing-cart-heading" style="width: 71%; white-space: nowrap; text-align: right;">[@{#table_heading_price#}@]</td>
              <td class="product-listing-cart-heading" style="width: 5%; white-space: nowrap; text-align: center;">&nbsp; [@{#table_heading_quantity#}@]</td>             
              <td class="product-listing-cart-heading" style="width: 12%; white-space: nowrap; text-align: center;">&nbsp;</td>                            
              <td class="product-listing-cart-heading" style="width: 2%; white-space: nowrap; text-align: right;">[@{#table_heading_total#}@]</td>             
             [@{/if}@] 
            ...
            [@{/if}@]          
              ...
              <td colspan="[@{if $tax_groups}@]7[@{else}@]6[@{/if}@]" class="product-listing-cart-data" style="white-space: nowrap;">&nbsp;&nbsp;&nbsp;<a href="[@{$product.link_filename_product_info}@]">[@{$product.products_image}@]</a></td>              
            </tr>                       
            [@{if (($smarty.foreach.outer.iteration-1)%2) == 0}@]
            <tr class="product-listing-cart-odd">
            [@{else}@]
            ...
            [@{/if}@]            
              <td class="product-listing-cart-data" style="vertical-align: top;">
                <table class="table-border-cellspacing cellpadding-0px">
                  ...
                  <tr>            
                    <td colspan="3" class="product-listing-cart-data" style="white-space: nowrap;">
                    [@{if $product.products_packaging_unit}@]
                      <img src="[@{$images_path}@]pixel_trans.gif" alt="" style="display: block; width: 100%; height: 4px;" />&nbsp; &nbsp;[@{#text_packaging_unit#}@]&nbsp;[@{$product.products_packaging_unit}@]<br />
                    [@{/if}@]                    
                    [@{if $product.link_filename_popup_content_products_delivery_time && $product.products_delivery_time}@]
                      <img src="[@{$images_path}@]pixel_trans.gif" alt="" style="display: block; width: 100%; height: 4px;" />&nbsp; &nbsp;<b>[@{#text_delivery_time#}@]</b>&nbsp;<a href="[@{$product.link_filename_popup_content_products_delivery_time}@]" class="lightbox-system-popup" target="_blank"><span class="text-deco-underline">[@{$product.products_delivery_time}@]</span></a><br />
                    [@{elseif $product.products_delivery_time}@]
                      <img src="[@{$images_path}@]pixel_trans.gif" alt="" style="display: block; width: 100%; height: 4px;" />&nbsp; &nbsp;<b>[@{#text_delivery_time#}@]</b>&nbsp;[@{$product.products_delivery_time}@]<br />
                    [@{/if}@]                                                           
                      <img src="[@{$images_path}@]pixel_trans.gif" alt="" style="display: block; width: 100%; height: 4px;" />
                    </td>                                        
                  </tr>                                                    
                </table>                 
              </td>                                                                   
              ...
              <td class="product-listing-cart-data" style="white-space: nowrap; vertical-align: bottom;"><input type="image" src="[@{$images_path}@]update.png" alt="[@{#text_update_product#}@]" title=" [@{#text_update_product#}@] " style="margin: 0 0 -1px 0" /><a href="[@{$product.link_remove_product}@]"><img src="[@{$images_path}@]trash_can.png" alt="[@{#text_remove_product#}@]" title=" [@{#text_remove_product#}@] " style="margin: 0 20px -1px 5px" /></a></td>
