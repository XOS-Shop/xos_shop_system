...
* filename   : tell_a_friend_email_html.tpl
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="2">
      ...
      <tr>
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td nowrap="nowrap" style="font-family: Verdana, Arial, sans-serif; font-size: 11px;">[@{eval var=#html_email_intro#}@]<br /><br /></td>
          </tr>
          [@{if $message}@]
          <tr>
            <td style="font-family: Verdana, Arial, sans-serif; font-size: 11px;">[@{$message|nl2br}@]<br /><br /></td>
          </tr>
          [@{/if}@]
          <tr>
            <td style="font-family: Verdana, Arial, sans-serif; font-size: 11px;">[@{#html_email_link#}@].<br /><a href="[@{$link_filename_product_info}@]">[@{$link_filename_product_info}@]</a><br /><br /></td>
          </tr> 
          <tr>
