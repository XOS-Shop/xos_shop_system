...
[@{if $boxes_categories_tabs_category_selected}@]        
          ...
          <div class="info-box-contents" style="padding: 4px 0 4px 0;">
            ...
            [@{foreach name=outer item=category from=$boxes_categories_tabs_full_categories_tree}@]
              ...
              <li class="[@{$category.class_name}@]" style="position: relative; z-index: [@{1300 - $smarty.foreach.outer.iteration}@];"><a href="[@{$category.href_link}@]">[@{$category.name}@][@{if $category.count_products}@]&nbsp;([@{$category.count_products}@])[@{/if}@]</a><span class="sub-cat-touchpad"><b></b></span><div class="clear">&nbsp;</div><ul class="ul-cat-inner">
