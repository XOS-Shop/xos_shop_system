...
<!-- shopping_cart -->
          ...
          <div id="shopping_cart_box" style="position:absolute; right:4px; top:50px;">                   
            ...
            [@{else}@]
              ...
              <div id="shopping_cart_box_title" class="info-box-contents" style="text-align: left; vertical-align: top; display:none;"><b>[@{#box_product_has_been_added#}@]<br />&nbsp;</b></div>
                ...
                [@{if $product.new_product_in_cart == true}@]  
                  <tr>
                    <td class="info-box-contents" style="text-align: right; vertical-align: top;"><span class="new-item-in-cart">[@{$product.quantity}@]&nbsp;x&nbsp;</span></td>
                    <td class="info-box-contents" style="text-align: left; vertical-align: top;">
                      ...
                      /* <![CDATA[ */
                        $(document).ready(function () {
                          $.colorbox({ 
                            ...
                            inline: true,
                            onLoad:function() { $("#shopping_cart_box_title").css({'display':'block'}); $("#shopping_cart_box_content").css({'width':'320px', 'float':'left'}); },
                ...
                [@{else}@]
                  <tr>
                    <td class="info-box-contents" style="text-align: right; vertical-align: top;"><span class="info-box-contents">[@{$product.quantity}@]&nbsp;x&nbsp;</span></td>
                    <td class="info-box-contents" style="text-align: left; vertical-align: top;"><a href="[@{$product.link_filename_product_info}@]"><span class="info-box-contents">[@{$product.name}@]</span></a></td>
                  </tr>
                [@{/if}@]    
                [@{/foreach}@]  
                </table>
                <div class="info-box-contents" style="padding: 2px 0 1px 0;"><img src="[@{$images_path}@]pixel_black.gif" alt="" style="display: block; width: 100%; height: 1px;" /></div>
