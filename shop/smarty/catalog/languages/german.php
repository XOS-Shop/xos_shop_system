...
define('ENTRY_DATE_OF_BIRTH_DAY_SELECT', 'Bitte wählen Sie einen Tag aus der Liste.');
define('ENTRY_DATE_OF_BIRTH_MONTH_SELECT', 'Bitte wählen Sie einen Monat aus der Liste.');
define('ENTRY_DATE_OF_BIRTH_JEAR_SELECT', 'Bitte wählen Sie ein Jahr aus der Liste.');
...
define('ENTRY_EMAIL_ADDRESS_ERROR_EXISTS', 'Diese E-Mail-Adresse existiert bereits in unseren Datensätzen. Bitte erstellen Sie Ihr Konto mit einer anderen Adresse.');
define('ENTRY_EMAIL_ADDRESS_ERROR_EXISTS_CHOOSE_DIFFERENT_ADDRESS', 'Diese E-Mail-Adresse existiert bereits in unseren Datensätzen. Bitte wählen Sie eine anderen Adresse.');
...
define('ENTRY_MISSING_HOUSE_NUMBER_TEXT_1', 'Hausnummer fehlt!');
define('ENTRY_MISSING_HOUSE_NUMBER_TEXT_2', 'Ignorieren Sie diese Meldung wenn Sie keine haben.');
...
define('ENTRY_PASSWORD_ERROR', 'Das Passwort muss mindestens ' . ENTRY_PASSWORD_MIN_LENGTH . ' Zeichen lang sein und sollte neben Groß- und Kleinbuchstaben auch Zahlen sowie Sonderzeichen enthalten.');
...
define('ENTRY_PASSWORD_PLACEHOLDER', 'Min. ' . ENTRY_PASSWORD_MIN_LENGTH . ' Zeichen Bsp. Yltx)7k!Iu');
