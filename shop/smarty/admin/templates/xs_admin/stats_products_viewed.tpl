...
* filename   : stats_products_viewed.tpl
          ...
          <tr>
            <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr class="dataTableHeadingRow">
                ...
                <td class="dataTableHeadingContent" align="center">[@{#table_heading_viewed#}@]&nbsp;</td>
              </tr>
              ...
              <tr class="dataTableRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)" onclick="document.location.href='[@{$product.link_filename_categories_action_product_preview}@]'">
                ...
                <td class="dataTableContent"><a href="[@{$product.link_filename_categories_action_product_preview}@]">[@{$product.products_name}@]</a>&nbsp;([@{$product.name}@])</td>
