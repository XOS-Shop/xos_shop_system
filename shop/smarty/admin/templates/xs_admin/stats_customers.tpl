          ...
          <tr>
            <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr class="dataTableHeadingRow">
                ...
                <td class="dataTableHeadingContent" align="right">[@{#table_heading_total_purchased#}@]&nbsp;</td>
              </tr>
              ...
              <tr class="dataTableRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)" onclick="document.location.href='[@{$customer.link_filename_customers}@]'">
                <td class="dataTableContent">[@{$customer.rows}@].</td>
                <td class="dataTableContent"><a href="[@{$customer.link_filename_customers}@]">[@{$customer.firstname}@]&nbsp;[@{$customer.lastname}@]</a></td>
                <td class="dataTableContent" align="right">[@{$customer.ordersum}@]&nbsp;</td>
              </tr>
              [@{/foreach}@]              
            </table></td>
          </tr>
