        ...
        <td width="100%">[@{$form_begin_new_file}@]<table border="0" width="100%" cellspacing="0" cellpadding="2">
          ...
          <tr>
            <td nowrap="nowrap" align="right" class="main" colspan="2">
              <a href="[@{$link_filename_file_manager}@]" class="button-default" style="float: right" title=" [@{#button_title_cancel#}@] "><span>[@{#button_text_cancel#}@]</span></a>
              [@{if $file_writeable}@]
        ...
        <td width="100%"><table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr>
            <td nowrap="nowrap" class="main">
              <a href="[@{$link_filename_file_manager}@]" class="button-default" style="float: left" title=" [@{#button_title_back#}@] "><span>[@{#button_text_back#}@]</span></a>           
            </td>
          </tr>        
          <tr>
            <td><img src="[@{$images_path}@]pixel_trans.gif" alt="" width="1" height="10" /></td>
          ...
          <tr>
            <td nowrap="nowrap" align="right" class="main">
              <a href="[@{$link_filename_file_manager}@]" class="button-default" style="float: right" title=" [@{#button_title_back#}@] "><span>[@{#button_text_back#}@]</span></a>           
            </td>
          </tr>
        </table></td>
      </tr>             
          ...
          <tr>
            <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              ...
              <tr class="dataTableRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)">
                ...
                <td class="dataTableContent" onclick="document.location.href='[@{$content.link_onclick}@]'">[@{$content.group}@]</td>
                <td class="dataTableContent" align="center" onclick="document.location.href='[@{$content.link_onclick}@]'">[@{$content.last_modified}@]</td>
                <td class="dataTableContent" align="right">[@{if $content.link_delete}@]<a href="[@{$content.link_delete}@]"><img src="[@{$images_path}@]icons/delete.gif" alt="[@{#icon_title_delete#}@]" title=" [@{#icon_title_delete#}@] " /></a>&nbsp;[@{/if}@]<a href="[@{$content.link_filename_file_manager_info}@]"><img src="[@{$images_path}@]icon_info.gif" alt="[@{#icon_title_info#}@]" title=" [@{#icon_title_info#}@] " /></a>&nbsp;</td>
              </tr>
              [@{/if}@]                        
              [@{/foreach}@]              
              <tr>
                <td colspan="7"><table border="0" width="100%" cellspacing="0" cellpadding="2">
                  <tr valign="top">
                    <td nowrap="nowrap"><a href="[@{$link_filename_file_manager_reset}@]" class="button-default" style="float: left" title=" [@{#button_title_reset#}@] "><span>[@{#button_text_reset#}@]</span></a></td>
                    <td nowrap="nowrap" align="right"><a href="[@{$link_filename_file_manager_new_folder}@]" class="button-default" style="float: right" title=" [@{#button_title_new_folder#}@] "><span>[@{#button_text_new_folder#}@]</span></a><a href="[@{$link_filename_file_manager_new_file}@]" class="button-default" style="margin-right: 5px; float: right" title=" [@{#button_title_new_file#}@] "><span>[@{#button_text_new_file#}@]</span></a><a href="[@{$link_filename_file_manager_upload}@]" class="button-default" style="margin-right: 5px; float: right" title=" [@{#button_title_upload#}@] "><span>[@{#button_text_upload#}@]</span></a></td>
                  </tr>
                </table></td>
              </tr>
            </table></td>
