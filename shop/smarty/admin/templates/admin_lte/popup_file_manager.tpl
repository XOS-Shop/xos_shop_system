...
<!-- file_manager --> 
    ...
    [@{if $entrence_link}@] 
          <div class="row">
            <div class="col-xs-12">                          
              <span style="margin-left: 12px;">[@{#text_please_select#}@]</span><br />
              <a href="[@{$link_filename_popup_file_manager}@]" class="btn btn-primary btn-margin-after-pagination" title=" [@{#button_title_file_manager#}@] ">[@{#button_text_file_manager#}@]</a>
              <a href="[@{$link_filename_popup_pages}@]" class="btn btn-primary btn-margin-after-pagination" title=" [@{#button_title_pages_in_menu_tree#}@] ">[@{#button_text_pages_in_menu_tree#}@]</a>
              <a href="[@{$link_filename_popup_info_pages}@]" class="btn btn-primary btn-margin-after-pagination" title=" [@{#button_title_info_pages#}@] ">[@{#button_text_info_pages#}@]</a>                                                                                                                                                                   
            </div>              
          </div>                   
    [@{else if $new_edit_file}@]   
          <div class="row">
            <div class="col-xs-12">                          
              ...
              <a href="[@{$link_filename_popup_file_manager}@]" class="btn btn-primary pull-right btn-margin-after-pagination" title=" [@{#button_title_cancel#}@] ">[@{#button_text_cancel#}@]</a>
              [@{if $file_writeable}@]
    ...
    [@{else if $image_view}@]                        
          <div class="row">
            <div class="col-xs-12">                          
              <div class="clearfix">
                <a href="[@{$link_filename_popup_file_manager}@]" class="btn btn-primary pull-right btn-margin-after-pagination" title=" [@{#button_title_back#}@] ">[@{#button_text_back#}@]</a>                                                   
              </div>
              <div class="box">
                <div class="box-body table-responsive">
    ...
    [@{else}@]               
          <div class="row">
            <div class="col-xs-8 col-md-9 data-table-wrapper">
              ...
              <a href="[@{$link_filename_popup_file_manager_reset}@]" class="btn btn-primary pull-left btn-margin-after-pagination" title=" [@{#button_title_reset#}@] ">[@{#button_text_reset#}@]</a>
              <a href="[@{$link_filename_popup_file_manager_new_folder}@]" class="btn btn-primary pull-right btn-margin-after-pagination" title=" [@{#button_title_new_folder#}@] ">[@{#button_text_new_folder#}@]</a><a href="[@{$link_filename_popup_file_manager_new_file}@]" class="btn btn-primary pull-right btn-margin-after-pagination" title=" [@{#button_title_new_file#}@] ">[@{#button_text_new_file#}@]</a><a href="[@{$link_filename_popup_file_manager_upload}@]" class="btn btn-primary pull-right btn-margin-after-pagination" title=" [@{#button_title_upload#}@] ">[@{#button_text_upload#}@]</a>
            </div> 
