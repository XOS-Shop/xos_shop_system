        ...
        <section class="content">
          ...
          <div class="row">
            <div class="col-xs-8 col-md-9 data-table-wrapper">
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    <tr class="data-table-heading-row">
                      ...
                      <th class="text-center">[@{#table_heading_zone_code#}@]</th>
                      <th class="text-right">[@{#table_heading_action#}@]</th>    
                    </tr> 
                    [@{foreach item=zone from=$zones}@]
                    [@{if $zone.selected}@]                                                                                        
                    <tr class="data-table-rows-elected" onclick="document.location.href='[@{$zone.link_filename_zones}@]'">
                    ...
                    [@{else}@]
                    <tr class="data-table-row" onclick="document.location.href='[@{$zone.link_filename_zones}@]'">
                      <td>[@{$zone.country_name}@]</td>
                      <td>[@{$zone.zone_name}@]</td>
                      <td class="text-center">[@{$zone.zone_code}@]</td>
                      <td class="text-right"><a href="[@{$zone.link_filename_zones}@]"><i class="fa fa-fw fa-info-circle" title=" [@{#icon_title_info#}@] "></i></a></td>
                    </tr>              
                    [@{/if}@]            
                    [@{/foreach}@]
                  </table>
              ...
              <a href="[@{$link_filename_zones_action_new}@]" class="btn btn-primary pull-right btn-margin-after-pagination" title=" [@{#button_title_new_zone#}@] ">[@{#button_text_new_zone#}@]</a>                                          
              [@{/if}@]
            </div> 
