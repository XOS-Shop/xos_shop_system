...
* filename   : menubox_content_manager.tpl
...
********************************************************************************
*}@]
<!-- menubox_content_manager -->
            <li class="treeview[@{if $menu_box_selected}@] active[@{/if}@]">
              <a href="#">
                <i class="fa fa-folder"></i> <span>[@{$menu_box_heading_name}@]</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
