...
* filename   : menubox_localization.tpl
...
********************************************************************************
*}@]
<!-- menubox_localization -->
            <li class="treeview[@{if $menu_box_selected}@] active[@{/if}@]">
              <a href="#">
                <i class="fa fa-language"></i> <span>[@{$menu_box_heading_name}@]</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
