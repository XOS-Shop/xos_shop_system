                  ...
                  <table class="table table-hover">
                    ...
                    <tr>
                      <td colspan="2">
                        ...
                        <table style="width: 100%;">
                          <tr>                                                
                            <td style="white-space: nowrap !important;">[@{$option.inputs_name|replace:'class="smallText"':'class="form-control input-sm" style="max-width: 65%; display: inline-block;"'}@][@{$option.hidden_id}@]</td>            
                            <td class="text-right"><a href="[@{$option.link_filename_products_attributes}@]" class="btn btn-default btn-xs btn-margin-attributes pull-right" title=" [@{#button_title_cancel#}@] ">[@{#button_text_cancel#}@]</a><a href="" onclick="option.submit(); return false" class="btn btn-default btn-xs btn-margin-attributes pull-right" title=" [@{#button_title_update#}@] ">[@{#button_text_update#}@]</a></td>                                                            
                          </tr>
                        </table>
                        [@{$option.form_end}@]
                      </td>
                    ...
                    <tr>
                      <td colspan="2">
                        ...
                        <table style="width: 100%;">
                          <tr>                                               
                            <td style="white-space: nowrap !important;">[@{$inputs_name|replace:'class="smallText"':'class="form-control input-sm" style="max-width: 65%; display: inline-block;"'}@]</td>
                            <td class="text-right"><a href="" onclick="options.submit(); return false" class="btn btn-default btn-xs btn-margin-attributes pull-right" title=" [@{#button_title_insert#}@] ">[@{#button_text_insert#}@]</a></td>                                                          
                          </tr>
                        </table>
                        [@{$form_end}@]
                      </td>
