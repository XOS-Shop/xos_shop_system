          ...
          <tr>
            <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">              
              ...
              <tr class="dataTableRowSelected" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)">
                ...
                [@{/if}@]
                <td class="dataTableContent" align="right" onclick="document.location.href='[@{$cc.link_filename_coupon_admin_edit}@]'">&nbsp;<i class="fa fa-fw fa-arrow-right"></i></td>
              </tr>             
              [@{else}@]
              <tr class="dataTableRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)">
                ...
                [@{else}@]
                  <a href="[@{$cc.link_filename_coupon_admin_action_setflag_Y}@]">[@{$cc.icon_status_green_light}@]</a>&nbsp;&nbsp;[@{$cc.icon_status_red}@]</td>
                [@{/if}@]
                <td class="dataTableContent" align="right" onclick="document.location.href='[@{$cc.link_filename_coupon_admin}@]'">&nbsp;<i class="fa fa-fw fa-info-circle" title=" [@{#icon_title_info#}@] "></i></td>
              </tr>
              [@{/if}@]               
              [@{/foreach}@]              
              <tr>
