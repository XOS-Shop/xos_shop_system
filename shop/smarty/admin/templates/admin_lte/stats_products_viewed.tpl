                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    <tr class="data-table-heading-row">
                      ...
                      <th class="text-center">[@{#table_heading_viewed#}@]</th>    
                    </tr> 
                    [@{foreach item=product from=$products}@]
                    <tr [@{*class="data-table-row"*}@] [@{*onclick="document.location.href='[@{$product.link_filename_categories_action_product_preview}@]'"*}@]>
                      <td>[@{$product.rows}@].</td>
                      <td><a href="[@{$product.link_filename_categories_action_product_preview}@]">[@{$product.products_name}@]</a>&nbsp;([@{$product.name}@])</td> 
                      <td class="text-center">[@{$product.viewed}@]</td>
                    </tr>                        
                    [@{/foreach}@]
                  </table>
                </div>
