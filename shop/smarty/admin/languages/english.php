...
define('BOX_CATALOG_DELIVERY_TIMES', 'Delivery times');
...
define('TEXT_DISPLAY_NUMBER_OF_DELIVERY_TIMES', 'Displaying <b>%d</b> to <b>%d</b> (of <b>%d</b> delivery times)');
...
define('CFG_VAL_TO_TXT_TRUE', 'Yes');
define('CFG_VAL_TO_TXT_FALSE', 'No');
define('CFG_VAL_TO_TXT_AND', 'and');
define('CFG_VAL_TO_TXT_OR', 'or');
define('CFG_VAL_TO_TXT_ASC', 'ascending');
define('CFG_VAL_TO_TXT_DESC', 'descending');
define('CFG_VAL_TO_TXT_WEIGHT', 'Weight');
define('CFG_VAL_TO_TXT_PRICE', 'Price');
define('CFG_VAL_TO_TXT_NATIONAL', 'national');
define('CFG_VAL_TO_TXT_INTERNATIONAL', 'international');
define('CFG_VAL_TO_TXT_BOTH', 'both');
define('CFG_VAL_TO_TXT_PRODUCTS_NAME', 'Product name');
define('CFG_VAL_TO_TXT_DATE_EXPECTED', 'Date expected');