...
define('BOX_CATALOG_DELIVERY_TIMES', 'Lieferzeiten');
...
define('ENTRY_STATE_ERROR', '&nbsp;<span class="errorText">notwendige Eingabe</span>');
...
define('TEXT_DISPLAY_NUMBER_OF_DELIVERY_TIMES', 'Angezeigt werden <b>%d</b> bis <b>%d</b> (von insgesamt <b>%d</b> Lieferzeiten)');
...
define('CFG_VAL_TO_TXT_TRUE', 'Ja');
define('CFG_VAL_TO_TXT_FALSE', 'Nein');
define('CFG_VAL_TO_TXT_AND', 'und');
define('CFG_VAL_TO_TXT_OR', 'oder');
define('CFG_VAL_TO_TXT_ASC', 'aufsteigend');
define('CFG_VAL_TO_TXT_DESC', 'absteigend');
define('CFG_VAL_TO_TXT_WEIGHT', 'Gewicht');
define('CFG_VAL_TO_TXT_PRICE', 'Preis');
define('CFG_VAL_TO_TXT_NATIONAL', 'national');
define('CFG_VAL_TO_TXT_INTERNATIONAL', 'international');
define('CFG_VAL_TO_TXT_BOTH', 'beides');
define('CFG_VAL_TO_TXT_PRODUCTS_NAME', 'Produktname');
define('CFG_VAL_TO_TXT_DATE_EXPECTED', 'Erscheinungsdatum');