...
//  define('MODULE_PAYMENT_PAYPAL_STANDARD_TEXT_DESCRIPTION', '<img src="' . DIR_WS_ADMIN_IMAGES . ADMIN_TPL . '/icon_popup.gif" alt="" />&nbsp;<a href="https://www.paypal.com/mrb/pal=PS2X9Q773CKG4" target="_blank" style="text-decoration: underline; font-weight: bold;">Visita la web de PayPal</a>&nbsp;<a href="javascript:toggleDivBlock(\'paypalStdInfo\');">(info)</a><span id="paypalStdInfo" style="display: none;"><br /><i>Con el uso del Link para usar PayPal XOS-Shop dar a cada Cliente nuevo un pequeno Bonus.</i></span>');
