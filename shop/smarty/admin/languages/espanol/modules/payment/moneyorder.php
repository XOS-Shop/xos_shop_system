...
////////////////////////////////////////////////////////////////////////////////
  ...
  define('MODULE_PAYMENT_MONEYORDER_TEXT_DESCRIPTION', 'Pagadero a:<br />' . (defined('MODULE_PAYMENT_MONEYORDER_PAYTO') ? nl2br(MODULE_PAYMENT_MONEYORDER_PAYTO) : '') . '<br /><br />Enviar a:<br />' . nl2br(STORE_NAME_ADDRESS) . '<br /><br />' . 'Su pedido se enviará en cuanto se reciba el pago.');
