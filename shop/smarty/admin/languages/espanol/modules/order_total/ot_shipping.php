...
////////////////////////////////////////////////////////////////////////////////
  ...
  define('MODULE_ORDER_TOTAL_SHIPPING_STATUS_DESCRIPTION', 'Do you want to display the order shipping cost?');
  define('MODULE_ORDER_TOTAL_SHIPPING_SORT_ORDER_DESCRIPTION', 'Sort order of display.');
  define('MODULE_ORDER_TOTAL_SHIPPING_FREE_SHIPPING_DESCRIPTION', 'Do you want to allow free shipping?');
  define('MODULE_ORDER_TOTAL_SHIPPING_FREE_SHIPPING_OVER_DESCRIPTION', 'Provide free shipping for orders over the set amount.');
  define('MODULE_ORDER_TOTAL_SHIPPING_DESTINATION_DESCRIPTION', 'Provide free shipping for orders sent to the set destination.');  
?>
