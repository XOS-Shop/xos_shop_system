...
define('CFG_VAL_TO_TXT_TRUE', 'sí');
define('CFG_VAL_TO_TXT_FALSE', 'no');
define('CFG_VAL_TO_TXT_AND', 'y');
define('CFG_VAL_TO_TXT_OR', 'o');
define('CFG_VAL_TO_TXT_ASC', 'ascendente');
define('CFG_VAL_TO_TXT_DESC', 'descendente');
define('CFG_VAL_TO_TXT_WEIGHT', 'peso');
define('CFG_VAL_TO_TXT_PRICE', 'precio');
define('CFG_VAL_TO_TXT_NATIONAL', 'nacional');
define('CFG_VAL_TO_TXT_INTERNATIONAL', 'internacionalmente');
define('CFG_VAL_TO_TXT_BOTH', 'ambos');
define('CFG_VAL_TO_TXT_PRODUCTS_NAME', 'nombre del producto');
define('CFG_VAL_TO_TXT_DATE_EXPECTED', 'fecha prevista');