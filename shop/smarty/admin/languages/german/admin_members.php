...
define('TEXT_INFO_ERROR_EMAIL_USED', '<span style="color: #ff0000;">Die eMail Adresse ist bereits vergeben! Bitte erneut versuchen!</span>');
define('TEXT_INFO_ERROR_EMAIL_NOT_VALID', '<span style="color: #ff0000;">Die eMail Adresse scheint nicht gültig zu sein - bitte korrigieren.</span>');
...
define('TEXT_INFO_GROUPS_NAME_FALSE', '<span style="color: #ff0000;"><b>Achtung:</b> Der Gruppenname muß mehr als 5 Buchstaben haben!</span>');
define('TEXT_INFO_GROUPS_NAME_USED', '<span style="color: #ff0000;"><b>Achtung:</b> Der Gruppenname existiert bereits!</span>');
