...
INSERT INTO configuration (configuration_key, configuration_value, configuration_group_id, sort_order, use_function, set_function, date_added) VALUES ('REGISTERED_TPLS', 'cyborg-responsive,default-responsive,hero-responsive,html5,osc-table', '12', '5', 'xos_get_registered_tpls_list', 'xos_cfg_checkbox_templates(', now());
