...
insert into banners_content (banners_id, language_id, banners_title, banners_url, banners_image, banners_html_text, banners_php_source) values ('2', '1', 'Note', '', '', '<div style=\"text-align: center; border-bottom: red 2px solid; border-left: red 2px solid; padding-bottom: 2px; background-color: rgb(216,216,216); padding-left: 10px; padding-right: 10px; font-family: arial; font-size: 16px; border-top: red 2px solid; border-right: red 2px solid; padding-top: 2px\">This is a default setup of the XOS-Shop project, products shown are for demonstrational purposes, any products purchased will not be delivered nor will the customer be billed. Any information seen on these products is to be treated as fictional.</div>', NULL);
insert into banners_content (banners_id, language_id, banners_title, banners_url, banners_image, banners_html_text, banners_php_source) values ('2', '2', 'Hinweis', '', '', '<div style=\"text-align: center; border-bottom: red 2px solid; border-left: red 2px solid; padding-bottom: 2px; background-color: rgb(216,216,216); padding-left: 10px; padding-right: 10px; font-family: arial; font-size: 16px; border-top: red 2px solid; border-right: red 2px solid; padding-top: 2px\">Dies ist eine XOS-Shop Standardinstallation. Alle hier gezeigten Produkte sind fiktiv zu verstehen. Eine hier getätigte Bestellung wird NICHT ausgeführt, Sie erhalten keine Lieferung oder Rechnung !</div>', NULL);
insert into banners_content (banners_id, language_id, banners_title, banners_url, banners_image, banners_html_text, banners_php_source) values ('2', '3', 'Nota', '', '', '<div style=\"text-align: center; border-bottom: red 2px solid; border-left: red 2px solid; padding-bottom: 2px; background-color: rgb(216,216,216); padding-left: 4px; padding-right: 4px; font-family: arial; font-size: 16px; border-top: red 2px solid; border-right: red 2px solid; padding-top: 2px\">Esta es la configuración por defecto de XOS-Shop, los productos mostrados aqui son únicamente para demonstración, cualquier compra realizada no será entregada al cliente, ni se le cobrará. Cualquier información que vea sobre estos productos debe ser tratada como ficticia.</div>', NULL);
...
insert into configuration (configuration_key, configuration_value, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) values ('DEFAULT_TPL', 'responsive', '12', '4', now(), now(), NULL, 'xos_cfg_pull_down_templates(');
insert into configuration (configuration_key, configuration_value, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) values ('REGISTERED_TPLS', 'black-tabs,black-tabs-cbox,black-tabs-cbox-dotted,blue-tabs-a,blue-tabs-b,blue-tabs-c,dark-standard,dark-tabs,html5,orange-standard,orange-tabs,osc-table,responsive', '12', '5', now(), now(), 'xos_get_registered_tpls_list', 'xos_cfg_checkbox_templates(');
